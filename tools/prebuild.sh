...
sed -i 's/0x090A0D38/0x00000000/g' asm/bodyprog/data/bodyprog_2.bss.s
sed -i 's/0x622E090A/0x00000000/g' asm/bodyprog/data/bodyprog_2.bss.s
sed -i 's/0x61783009/0x00000000/g' asm/bodyprog/data/bodyprog_3.bss.s
sed -i 's/0x2E090A0D/0x00000000/g' asm/bodyprog/data/bodyprog_3.bss.s

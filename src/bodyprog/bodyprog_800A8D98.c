...
{
/* `Chara_` name       { `animFileIdx`          `modelFileIdx`        `textureFileIdx`       `field_6` `field_6_10` `field_8`    `field_C_0`             `offsetY_C_2` } */
/* None             */ {  NO_VALUE,              0,                    0,                     0,        0,           NULL,        CameraAnchor_Character, Q8(0.0f),    },
...
/* Padlock          */ {  0,                     0,                    0,                     0,        0,           NULL,        CameraAnchor_Character, Q8(0.0f),    }
};

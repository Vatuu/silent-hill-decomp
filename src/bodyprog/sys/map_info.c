...
s_MapEffectsInfo MAP_EFFECTS_INFOS[21] = {
    {
        ...
        .worldTintB             = Q12(1.0f),
        .field_E                = 0,
        .fogDistance            = Q12(100.0f),
        .fogColor               = { 60, 60, 68, 0 },
        .enableTintLightOverlap = false,
        .pointLightTint         = { 0, 0, 0, 0 },
        .worldTint              = { 0, 0, 0, 0 },
        .field_21               = { 64, 64, 64, 0 },
        .field_25               = { 12, 12, 28, 0 }
    },
    { 
        ...
        .field_E                = 1,
        .fogDistance            = Q12(13.5f),
        .fogColor               = { 108, 100, 116, 0 },
        .enableTintLightOverlap = false,
        .pointLightTint         = { 0, 0, 0, 0 },
        .worldTint              = { 0, 0, 0, 0 },
        .field_21               = { 48, 48, 48, 0 },
    ...
    { 
        ...
        .field_E                = 1,
        .fogDistance            = Q12(14.0f),
        .fogColor               = { 100, 92, 108, 0 },
        .enableTintLightOverlap = false,
        .pointLightTint         = { 0, 0, 0, 0 },
        .worldTint              = { 0, 0, 0, 0 },
        .field_21               = { 48, 48, 48, 0 },
    ...
    { 
        ...
        .worldTintB             = Q12(1.08f),
        .field_E                = 0,
        .fogDistance            = Q12(CHUNK_CELL_SIZE),
        .fogColor               = { 0, 0, 0, 0 },
        .enableTintLightOverlap = false,
        .pointLightTint         = { 0, 0, 0, 0 },
        .worldTint              = { 0, 0, 0, 0 },
    ...
    { 
        ...
        .fogDistance            = Q12(13.5f),
        .fogColor               = { 68, 60, 76, 0 },
        .enableTintLightOverlap = true,
        .pointLightTint         = { 24, 16, 32, 0 },
        .worldTint              = { 85, 75, 75, 0 },
        .field_21               = { 32, 32, 40, 0 },
        .field_25               = { 12, 12, 28, 0 }
    },
    { 
    ...
    { 
        ...
        .worldTintB             = Q12(0.9f),
        .field_E                = 1,
        .fogDistance            = Q12(6.5f),
        .fogColor               = { 108, 100, 100, 0 },
        .enableTintLightOverlap = false,
        .pointLightTint         = { 0, 0, 0, 0 },
        .worldTint              = { 0, 0, 0, 0 },
        .field_21               = { 48, 48, 48, 0 },

...
void Inventory_ExitAnimEquippedItemUpdate(u8* arg0) // 0x8004C088
{
    ...
    // Set anim alpha.
    modelPtr3->anim_4.alpha_A      = QX_12(1.0f);
    extraModelPtr2->anim_4.alpha_A = QX_12(1.0f);
    ...
    Anim_BoneUpdate((s_AnmHeader*)FS_BUFFER_0, g_SysWork.playerBoneCoords_890, modelPtr3->anim_4.keyframeIdx_8, modelPtr3->anim_4.keyframeIdx_8, QX_12(1.0f));
    ...
    Anim_BoneUpdate((s_AnmHeader*)FS_BUFFER_0, g_SysWork.playerBoneCoords_890, extraModelPtr2->anim_4.keyframeIdx_8, extraModelPtr2->anim_4.keyframeIdx_8, QX_12(1.0f));
    func_8004C040();
}

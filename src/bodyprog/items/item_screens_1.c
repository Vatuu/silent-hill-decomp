        ...
        switch (g_SysWork.player_4C.extra_128.lowerBodyState_24)
        {
            ...
            default:
                    ...
                    (s8)D_800C3950 == g_SysWork.playerCombatInfo_38.equippedWeapon_F)
                {
                    ...
                    if (extraModelPtr0->anim_4.status_0 >= ANIM_STATUS_GET(33, false))
                    {
                ...
                else
                {
                    ...
                    modelPtr1->anim_4.status_0                       = ANIM_STATUS_GET(1, true);
                    modelPtr1->anim_4.keyframeIdx0_8                  = 0;
                    extraModelPtr1->anim_4.status_0                  = ANIM_STATUS_GET(1, true);

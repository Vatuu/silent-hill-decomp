...
q19_12 g_Items_PickupScale     = QX_12(0.0f);
...
{
    { Anim_Update2, ANIM_STATUS(PlayerAnim_Still,                   false), false, ANIM_STATUS(PlayerAnim_Still,                   true), { QX_12(10)    }, NO_VALUE, 0   },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_Still,                   true),  false, NO_VALUE,                                              { QX_12(30)    }, NO_VALUE, 1   },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_TransitionToStill,       false), false, ANIM_STATUS(PlayerAnim_TransitionToStill,       true), { QX_12(10)    }, NO_VALUE, 0   },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_TransitionToStill,       true),  false, NO_VALUE,                                              { QX_12(0)     }, 0,        0   },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_WalkForward,             false), false, ANIM_STATUS(PlayerAnim_WalkForward,             true), { QX_12(50)    }, NO_VALUE, 1   },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_WalkForward,             true),  true,  NO_VALUE,                                              { func_800706E4 }, 1,        23  },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunForward,              false), false, ANIM_STATUS(PlayerAnim_RunForward,              true), { QX_12(20)    }, NO_VALUE, 26  },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_RunForward,              true),  true,  NO_VALUE,                                              { func_800706E4 }, 26,       45  },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_WalkBackward,            false), false, ANIM_STATUS(PlayerAnim_WalkBackward,            true), { QX_12(20)    }, NO_VALUE, 46  },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_WalkBackward,            true),  true,  NO_VALUE,                                              { func_800706E4 }, 46,       69  },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_SidestepLeft,            false), false, ANIM_STATUS(PlayerAnim_SidestepLeft,            true), { QX_12(50)    }, NO_VALUE, 70  },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_SidestepLeft,            true),  false, NO_VALUE,                                              { QX_12(30)    }, 70,       94  },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_SidestepRight,           false), false, ANIM_STATUS(PlayerAnim_SidestepRight,           true), { QX_12(50)    }, NO_VALUE, 95  },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_SidestepRight,           true),  false, NO_VALUE,                                              { QX_12(30)    }, 95,       119 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunLeft,                 false), false, ANIM_STATUS(PlayerAnim_RunLeft,                 true), { QX_12(20)    }, NO_VALUE, 121 },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_RunLeft,                 true),  false, NO_VALUE,                                              { QX_12(20)    }, 121,      133 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunRight,                false), false, ANIM_STATUS(PlayerAnim_RunRight,                true), { QX_12(20)    }, NO_VALUE, 136 },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_RunRight,                true),  false, NO_VALUE,                                              { QX_12(20)    }, 136,      148 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunForwardWallStopRight, false), false, ANIM_STATUS(PlayerAnim_RunForwardWallStopRight, true), { QX_12(50)    }, NO_VALUE, 150 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_RunForwardWallStopRight, true),  false, ANIM_STATUS(PlayerAnim_RunForwardWallStopRight, true), { QX_12(15)    }, 150,      159 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunForwardWallStopLeft,  false), false, ANIM_STATUS(PlayerAnim_RunForwardWallStopLeft,  true), { QX_12(50)    }, NO_VALUE, 160 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_RunForwardWallStopLeft,  true),  false, ANIM_STATUS(PlayerAnim_RunForwardWallStopLeft,  true), { QX_12(15)    }, 160,      169 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunForwardStumble,       false), false, ANIM_STATUS(PlayerAnim_RunForwardStumble,       true), { QX_12(50)    }, NO_VALUE, 170 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_RunForwardStumble,       true),  false, ANIM_STATUS(PlayerAnim_RunForwardStumble,       true), { QX_12(15)    }, 170,      179 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_TurnLeft,                false), false, ANIM_STATUS(PlayerAnim_TurnLeft,                true), { QX_12(50)    }, NO_VALUE, 180 },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_TurnLeft,                true),  false, NO_VALUE,                                              { QX_12(15)    }, 180,      192 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_TurnRight,               false), false, ANIM_STATUS(PlayerAnim_TurnRight,               true), { QX_12(50)    }, NO_VALUE, 193 },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_TurnRight,               true),  false, NO_VALUE,                                              { QX_12(15)    }, 193,      205 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_QuickTurnRight,          false), false, ANIM_STATUS(PlayerAnim_QuickTurnRight,          true), { QX_12(50)    }, NO_VALUE, 206 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_QuickTurnRight,          true),  false, ANIM_STATUS(PlayerAnim_QuickTurnRight,          true), { QX_12(28)    }, 206,      217 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_QuickTurnLeft,           false), false, ANIM_STATUS(PlayerAnim_QuickTurnLeft,           true), { QX_12(50)    }, NO_VALUE, 219 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_QuickTurnLeft,           true),  false, ANIM_STATUS(PlayerAnim_QuickTurnLeft,           true), { QX_12(28)    }, 219,      230 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_JumpBackward,            false), false, ANIM_STATUS(PlayerAnim_JumpBackward,            true), { QX_12(10)    }, NO_VALUE, 240 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_JumpBackward,            true),  false, ANIM_STATUS(PlayerAnim_JumpBackward,            true), { QX_12(10)    }, 240,      247 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_LookAround,              false), false, ANIM_STATUS(PlayerAnim_LookAround,              true), { QX_12(50)    }, NO_VALUE, 248 },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_LookAround,              true),  false, NO_VALUE,                                              { QX_12(7)     }, 248,      320 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunLeftWallStop,         false), false, ANIM_STATUS(PlayerAnim_RunLeftWallStop,         true), { QX_12(50)    }, NO_VALUE, 321 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_RunLeftWallStop,         true),  false, ANIM_STATUS(PlayerAnim_RunLeftWallStop,         true), { QX_12(20)    }, 321,      336 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunLeftStumble,          false), false, ANIM_STATUS(PlayerAnim_RunLeftStumble,          true), { QX_12(50)    }, NO_VALUE, 337 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_RunLeftStumble,          true),  false, ANIM_STATUS(PlayerAnim_RunLeftStumble,          true), { QX_12(15)    }, 337,      349 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunRightWallStop,        false), false, ANIM_STATUS(PlayerAnim_RunRightWallStop,        true), { QX_12(50)    }, NO_VALUE, 350 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_RunRightWallStop,        true),  false, ANIM_STATUS(PlayerAnim_RunRightWallStop,        true), { QX_12(20)    }, 350,      365 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_RunRightStumble,         false), false, ANIM_STATUS(PlayerAnim_RunRightStumble,         true), { QX_12(50)    }, NO_VALUE, 366 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_RunRightStumble,         true),  false, ANIM_STATUS(PlayerAnim_RunRightStumble,         true), { QX_12(15)    }, 366,      378 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_FallForward,             false), false, ANIM_STATUS(PlayerAnim_FallForward,             true), { QX_12(30)    }, NO_VALUE, 387 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_FallForward,             true),  false, ANIM_STATUS(PlayerAnim_FallForward,             true), { QX_12(20)    }, 387,      417 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_FallBackward,            false), false, ANIM_STATUS(PlayerAnim_FallBackward,            true), { QX_12(30)    }, NO_VALUE, 418 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_FallBackward,            true),  false, ANIM_STATUS(PlayerAnim_FallBackward,            true), { QX_12(20)    }, 418,      456 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_Kick,                    false), false, ANIM_STATUS(PlayerAnim_Kick,                    true), { QX_12(5)     }, NO_VALUE, 457 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_Kick,                    true),  false, ANIM_STATUS(PlayerAnim_Kick,                    true), { QX_12(20)    }, 457,      484 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_Stomp,                   false), false, ANIM_STATUS(PlayerAnim_Stomp,                   true), { QX_12(5)     }, NO_VALUE, 485 },
    { Anim_Update0, ANIM_STATUS(PlayerAnim_Stomp,                   true),  false, ANIM_STATUS(PlayerAnim_Stomp,                   true), { QX_12(20)    }, 485,      502 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_Idle,                    false), false, ANIM_STATUS(PlayerAnim_Idle,                    true), { QX_12(5)     }, NO_VALUE, 503 },
    { Anim_Update1, ANIM_STATUS(PlayerAnim_Idle,                    true),  false, NO_VALUE,                                              { QX_12(10)    }, 503,      542 },
    { Anim_Update2, ANIM_STATUS(PlayerAnim_IdleExhausted,           false), false, ANIM_STATUS(PlayerAnim_IdleExhausted,           true), { QX_12(5)     }, NO_VALUE, 543 },
...
void Gfx_Inventory_HealthStatusDraw() 
{
    ...
    if (health < QX_12(10.0f))
    {
        healthStage = 3;
    } 
    else if (health < QX_12(50.0f))
    {
        healthStage = 2;
    }
    else
    ...
    for (i = 0; i < 3; i++)
    {
        if (i != 1 || g_Inventory_HealthStatusScanlineTimer >= 30)
        {
            if (i == 2)
            {
                if (g_SysWork.player_4C.chara_0.health_B0 != QX_12(100.0f) &&
    ...
    if (g_SysWork.player_4C.chara_0.health_B0 < QX_12(10.0f))
    {
        healthStage = 3;
    }
    else if (g_SysWork.player_4C.chara_0.health_B0 < QX_12(50.0f))
    {
        healthStage = 2;
    }
    else
...
void Gfx_Results_ItemsPosition() // 0x8005227C
{
    ...
    for (i = 0; i < DISPLAY_ITEM_COUNT; i++)
    {
        if ((D_800C3E40 >> i) & (1 << 0))
        {
            ...
            g_Items_Transforms[i].scale.vz   = QX_12(1.0f);
            g_Items_Transforms[i].scale.vy   = QX_12(1.0f);
            g_Items_Transforms[i].scale.vx   = QX_12(1.0f);
...
void Gfx_Items_SetAmbientLighting() // 0x80054928
{
    ...
    for (i = 0; i < 10; i++)
    {
        ...
        g_Items_Lights[i][1].vx = QX_12(1.0f);
        g_Items_Lights[i][1].vy = QX_12(0.0f);
        g_Items_Lights[i][1].vz = QX_12(0.0f);
...
void func_800549A0() // 0x800549A0
{
    ...
    g_Items_Lights[IDX][1].vx = QX_12(1.0f);
    ...
    g_Items_Lights[IDX][1].vy = QX_12(0.0f);
    g_Items_Lights[IDX][1].vz = QX_12(0.0f);
...
void func_80054A04(u8 itemId) // 0x80054A04
{
    ...
    g_Items_PickupScale     = QX_12(0.0f);
    ...
    g_Items_Transforms[9].scale.vz = QX_12(1.0f);
    g_Items_Transforms[9].scale.vy = QX_12(1.0f);
    g_Items_Transforms[9].scale.vx = QX_12(1.0f);
...
bool Gfx_PickupItemAnimate(u8 itemId) // 0x80054AD8
{
    ...
    switch (g_Items_PickupAnimState) 
    {
        case 0: // Expand without rotation?
            if (g_Items_PickupScale >= QX_12(0.5f)) 
            {
    ...
    g_Items_PickupScale  = CLAMP(g_Items_PickupScale, QX_12(0.0f), QX_12(0.5f));

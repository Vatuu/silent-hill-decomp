    ...
    for (i = 0; i < 24; i++)
    {
        ...
        if (D_800C42E8[i].field_0 != 0)
        {
            ...
            ptr->field_34[i] = CLAMP_CUSTOM((var_a2->position_18.vx + var_a2->field_D8.offsetX_0) - D_800C42E8[i].field_4,
                                            (var_a2->position_18.vx + var_a2->field_D8.offsetX_0) - curPtr->field_4,
            ...
            ptr->field_64[i] = CLAMP_CUSTOM((var_a2->position_18.vy + var_a2->field_CE) - D_800C42E8[i].field_2,
                                            (var_a2->position_18.vy + var_a2->field_CE) - curPtr->field_2,
            ...
            ptr->field_94[i] = CLAMP_CUSTOM((var_a2->position_18.vz + var_a2->field_D8.offsetZ_2) - D_800C42E8[i].field_8,
                                            (var_a2->position_18.vz + var_a2->field_D8.offsetZ_2) - curPtr->field_8,
                                            -FP_MULTIPLY_PRECISE(g_DeltaTime0, Q12(1.25f), Q12_SHIFT),
                                            FP_MULTIPLY_PRECISE(g_DeltaTime0, Q12(1.25f), Q12_SHIFT));
...
void func_8005F6B0(s_SubCharacter* chara, VECTOR* arg1, s32 arg2, s32 arg3) // 0x8005F6B0
{
    s_Collision    sp10;
    VECTOR3        sp20;
    u32            sp30[150];
    ...
    if (arg2 != 8)
    {
        ...
        if (i != 24)
        {
            ...
            D_800C42E8[i].field_2 = chara->position_18.vy + chara->field_CE;
    ...
    for (j = 0; j < g_MapOverlayHeader.bloodSplatCount_58; j++)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                var_a1 = ABS(sp20.vx - g_MapOverlayHeader.unkTable1_4C[g_MapOverlayHeader.bloodSplats_54[j].field_0].vx_0);
                var_v0 = ABS(sp20.vz - g_MapOverlayHeader.unkTable1_4C[g_MapOverlayHeader.bloodSplats_54[j].field_0].vz_4);

                sp30[j] = MAX(var_a1, var_v0) + (CLAMP_HIGH(var_a1, var_v0) >> 1);
                ...
                {
                    sp30[j] += Rng_TestProbabilityBits(14);
                }
            }
        }
    }
    ...
    for (j = 0; j < var_s7; j++)
    {
        if (sp30[j] != 0x7FFFFFFF)
        {
            for (var_a1_2 = j + 1; var_a1_2 < g_MapOverlayHeader.bloodSplatCount_58; var_a1_2++)
            {
                ...
                sp30[j]   = sp30[var_a1_2];
                sp30[var_a1_2] = temp_a0_2;

                var_s3                                              = g_MapOverlayHeader.bloodSplats_54[j].field_0;
...
bool func_80060044(POLY_FT4** poly, s32 arg1) // 0x80060044
{
    s32              temp_v0_2;
    s32              temp_v1_5;
    s32              temp_v1_5_;
    ...
    ptr->field_148 = g_MapOverlayHeader.unkTable1_4C[arg1].field_10.s_0.field_0;
    ...
    {
        g_MapOverlayHeader.unkTable1_4C[arg1].field_10.s_0.field_0 += g_DeltaTime0;
    }

    temp_a1 = g_MapOverlayHeader.unkTable1_4C[arg1].field_B >> 2;
    if ((u16)g_MapOverlayHeader.unkTable1_4C[arg1].field_10.s_0.field_0 >= 5233)
    {
    ...
    if (temp_a1 != 24)
    {
        g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 += ptr->field_0.field_34[temp_a1];
        g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 += ptr->field_0.field_64[temp_a1];
        g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 += ptr->field_0.field_94[temp_a1];
    }

    *(u32*)&ptr->field_138.vx = (((g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 >> 4) - (u16)ptr->field_0.field_0.vx) & 0xFFFF) + (((g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 >> 4) - ptr->field_0.field_0.vy) << 0x10);
    ...
    if (ABS(ptr->field_144.vx) >= 201 || ABS(ptr->field_144.vy) >= 161)
    {
        return false;
    }
    ...
    if (g_GameWork.config_0.optExtraBloodColor_24 == 14)
    {
        temp_s0             = func_80055D78(g_MapOverlayHeader.unkTable1_4C[arg1].vx_0, g_MapOverlayHeader.unkTable1_4C[arg1].vy_8, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4);
        *(u16*)&(*poly)->r0 = temp_s0 + (func_80055D78(g_MapOverlayHeader.unkTable1_4C[arg1].vx_0, g_MapOverlayHeader.unkTable1_4C[arg1].vy_8, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4) << 8);
        (*poly)->b0         = func_80055D78(g_MapOverlayHeader.unkTable1_4C[arg1].vx_0, g_MapOverlayHeader.unkTable1_4C[arg1].vy_8, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4);
    }
    else
    {
...
bool func_800611C0(POLY_FT4** arg0, s32 arg1) // 0x800611C0
{
    ...
    if (!(g_MapOverlayHeader.unkTable1_4C[arg1].field_B & 0x3))
    {
        temp_a3 = g_MapOverlayHeader.unkTable1_4C[arg1].field_B >> 2;

        if (temp_a3 != 24)
        {
            g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 += ptr->field_0.field_34[temp_a3];
            g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 += ptr->field_0.field_64[temp_a3];
            g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 += ptr->field_0.field_94[temp_a3];
        }

        g_MapOverlayHeader.unkTable1_4C[arg1].field_10.s_0.field_0 = MIN(g_MapOverlayHeader.unkTable1_4C[arg1].field_10.s_0.field_0 + (g_DeltaTime2 >> 2), 0x2000);

        g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 += g_MapOverlayHeader.unkTable1_4C[arg1].field_10.s_0.field_0;

        if (g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 > g_MapOverlayHeader.unkTable1_4C[arg1].field_10.s_0.field_2)
        {
            if (temp_a3 != 24)
            {
                if (D_800C42E8[temp_a3].field_0 & 2)
                {
                    D_800C42E8[temp_a3].field_0 -= 2;
                }
            }

            g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 = g_MapOverlayHeader.unkTable1_4C[arg1].field_10.s_0.field_2;
            ...
            Collision_Get(&colls[2], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 + ptr->field_178);
            Collision_Get(&colls[3], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 - ptr->field_178);

            if (func_8005F680(&colls[0]) || func_8005F680(&colls[1]) || func_8005F680(&colls[2]) || func_8005F680(&colls[3]) ||
                (g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 - colls[0].groundHeight_0) < Q12(-0.2f) || (g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 - colls[1].groundHeight_0) < Q12(-0.2f) ||
                (g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 - colls[2].groundHeight_0) < Q12(-0.2f) || (g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 - colls[3].groundHeight_0) < Q12(-0.2f))
            {
                g_MapOverlayHeader.unkTable1_4C[arg1].field_A = 0;
            }
            else
            {
                g_MapOverlayHeader.unkTable1_4C[arg1].field_B          = 1;
                g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 = Rng_TestProbabilityBits(8);
            }
    ...
    ptr->field_168 = g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0;

    if (g_MapOverlayHeader.unkTable1_4C[arg1].field_B == 2)
    {
        if (*g_MapOverlayHeader.data_190 != 0)
        {
            g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 += g_DeltaTime0;
            if (g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 > 0x32000)
            {
                g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 = 0x32000;
            }
    ...
    else
    {
        ...
        if (g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 >= 0xCC1)
        {
            if (g_MapOverlayHeader.unkTable1_4C[arg1].field_B == 1)
            {
    ...
    if (ABS(ptr->field_14C.vx - g_MapOverlayHeader.unkTable1_4C[arg1].vx_0) + ABS(ptr->field_14C.vz - g_MapOverlayHeader.unkTable1_4C[arg1].vz_4) > 0x14000)
    {
    ...
    *(s32*)&ptr->field_134.vx = ((((g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 - ptr->field_178) >> 4) - (u16)ptr->field_0.field_0.vx) & 0xFFFF) +
                                (((g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 >> 4) - ptr->field_0.field_0.vy) << 16);

    ptr->field_134.vz = ((g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 + ptr->field_178) >> 4) - ptr->field_0.field_0.vz;

    *(s32*)&ptr->field_13C.vx = ((((g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 + ptr->field_178) >> 4) - (u16)ptr->field_0.field_0.vx) & 0xFFFF) +
                                (((g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 >> 4) - ptr->field_0.field_0.vy) << 16);

    ptr->field_13C.vz = ((g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 + ptr->field_178) >> 4) - ptr->field_0.field_0.vz;

    *(s32*)&ptr->field_144.vx = ((((g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 - ptr->field_178) >> 4) - (u16)ptr->field_0.field_0.vx) & 0xFFFF) +
                                (((g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 >> 4) - ptr->field_0.field_0.vy) << 16);

    ptr->field_144.vz = ((g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 - ptr->field_178) >> 4) - ptr->field_0.field_0.vz;
    ...
    *(s32*)&ptr->field_134.vx = ((((g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 + ptr->field_178) >> 4) - (u16)ptr->field_0.field_0.vx) & 0xFFFF) +
    ...
    if (ABS(ptr->field_16C.vx) >= 201)
    {
        return false;
    }

    if (ABS(ptr->field_16C.vy) >= 161)
    {
        return false;
    }
    ...
    *(s32*)&(*arg0)->x3 = *(s32*)&ptr->field_16C;
    ...
    else if (g_MapOverlayHeader.unkTable1_4C[arg1].field_B == 2)
    {
        if (*g_MapOverlayHeader.data_190 != 0)
        {
    ...
    *(s32*)&(*arg0)->u1 = ((ptr->field_190 + ptr->field_198) << 8) + 0x4B0000 + (ptr->field_17C + ptr->field_184);
    ...
    *(s32*)&(*arg0)->u3 = ((ptr->field_190 + ptr->field_1A0) << 8) + (ptr->field_17C + ptr->field_18C);
    ...
    if (!(g_SysWork.field_2388.field_154.field_0.field_0.field_0 & 3))
    {
        *(s32*)&(*arg0)->u0 = ((ptr->field_190 + ptr->field_194) << 8) + 0x930000 + (ptr->field_17C + ptr->field_180);
        func_80055A90(&ptr->field_12C, &ptr->field_130, var_t0, ptr->field_158 * 0x10);
        *(u16*)&(*arg0)->r0 = ptr->field_12C.r + (ptr->field_12C.g << 8);
        (*arg0)->b0         = ptr->field_12C.b;
        ...
        *(u16*)&(*arg0 + 1)->r0 = ptr->field_130.r + (ptr->field_130.g << 8);
        ...
        addPrim(&g_OrderingTable0[g_ActiveBufferIdx].org[ptr->field_158 >> 3], *arg0);
        addPrim(&g_OrderingTable0[g_ActiveBufferIdx].org[ptr->field_158 >> 3], *arg0 + 1);
        addPrim(&g_OrderingTable0[g_ActiveBufferIdx].org[ptr->field_158 >> 3], *arg0 + 2);
...
bool func_80062708(POLY_FT4** poly, s32 arg1) // 0x80062708
{
    ...
    if (g_MapOverlayHeader.unkTable1_4C[arg1].field_B & 4)
    {
        g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 += g_DeltaTime0;

        if (g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 >= 0x2801)
        {
            g_MapOverlayHeader.unkTable1_4C[arg1].field_B         -= 4;
            g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 = 0;
        }
        return false;
    }

    ptr->field_208 = g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0;

    if (*g_MapOverlayHeader.data_190 != 0)
    {
        g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 += g_DeltaTime0;

        if (g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 > 0x2D000)
        {
            g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 = 0x2D000;
        }
    }
    else
    {
        if (g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 < 0x5000)
        {
            g_MapOverlayHeader.unkTable1_4C[arg1].field_10.field_0 += g_DeltaTime0;
        }
    }
    ...
    if (ABS(ptr->field_1FC.vx - g_MapOverlayHeader.unkTable1_4C[arg1].vx_0) +
            ABS(ptr->field_1FC.vz - g_MapOverlayHeader.unkTable1_4C[arg1].vz_4) >
        0x14000)
    {
        return false;
    }
    ...
    else
    {
        ...
        {
            Collision_Get(&colls[0], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 - temp_s2, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4);
            Collision_Get(&colls[1], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 + temp_s2, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4);
            Collision_Get(&colls[2], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 - temp_s2);
            Collision_Get(&colls[3], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 + temp_s2);
        }
        else
        {
            Collision_Get(&colls[0], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 - temp_s2, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 - temp_s2);
            Collision_Get(&colls[1], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 + temp_s2, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 - temp_s2);
            Collision_Get(&colls[2], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 - temp_s2, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 + temp_s2);
            Collision_Get(&colls[3], g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 + temp_s2, g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 + temp_s2);
        }

        if (func_8005F680(&colls[0]) || func_8005F680(&colls[1]) || func_8005F680(&colls[2]) || func_8005F680(&colls[3]) ||
            ABS(colls[0].groundHeight_0 - g_MapOverlayHeader.unkTable1_4C[arg1].vy_8) >= 0x267 ||
            ABS(colls[1].groundHeight_0 - g_MapOverlayHeader.unkTable1_4C[arg1].vy_8) >= 0x267 ||
    ...
    ptr->field_210 = (g_MapOverlayHeader.unkTable1_4C[arg1].field_B << 0xD) + 0xE0;

    for (i = 0; i < 5; i++)
    {
        for (j = 0; j < 5; j++)
        {
            *(s32*)&ptr->field_134[i * 5 + j].vx = (((((g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 >> 4) - (u16)ptr->field_0.field_0.vx) - (u16)ptr->field_2DC) + ((ptr->field_2DC >> 1) * j)) & 0xFFFF) +
                                                   ((((g_MapOverlayHeader.unkTable1_4C[arg1].vy_8) >> 4) - ptr->field_0.field_0.vy) << 0x10);

            ptr->field_134[i * 5 + j].vz = (((g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 >> 4) - ptr->field_0.field_0.vz) - ptr->field_2DC) + ((ptr->field_2DC >> 1) * i);
        }
    }
...
void func_8006342C(s32 weaponAttack, q3_12 angle, s16 arg2, GsCOORDINATE2* coord) // 0x8006342C
{
    ...
    for (i = 0; i < ptr->field_50; i++)
    {
        ...
        g_MapOverlayHeader.unkTable1_4C[ptr->field_3C[i]].vx_0 = (Q4_TO_Q8(ptr->field_28.vx) + Rng_TestProbabilityBits(8)) - 0x80;
        g_MapOverlayHeader.unkTable1_4C[ptr->field_3C[i]].vy_8 = (Q4_TO_Q8((u16)ptr->field_28.vy) + Rng_TestProbabilityBits(8)) - 0x80;
        g_MapOverlayHeader.unkTable1_4C[ptr->field_3C[i]].vz_4 = (Q4_TO_Q8(ptr->field_28.vz) + Rng_TestProbabilityBits(8)) - 0x80;
...
bool func_80063A50(POLY_FT4** poly, s32 arg1) // 0x80063A50
{
    ...
    g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 = Q4_TO_Q8(ptr->field_1AC.vx);
    g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 = Q4_TO_Q8((u16)ptr->field_1AC.vy);
    g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 = Q4_TO_Q8(ptr->field_1AC.vz);
    ...
    for (ptr->field_1D4 = 0; ptr->field_1D4 < 6; ptr->field_1D4++)
    {
        ...
        *(s32*)&ptr->field_14C[0].vx = ((((u16)g_MapOverlayHeader.unkTable1_4C[arg1].field_C.field_0 + FP_MULTIPLY(ptr->field_1E8, Math_Cos(ptr->field_1D0), Q12_SHIFT)) - FP_ANGLE(90.0f)) & 0xFFFF) +
        ...
        {
            *(s32*)&ptr->field_14C[ptr->field_1D8] = (((Q8_TO_Q4(g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 + ptr->field_16C[ptr->field_1D8].vx) - (u16)ptr->field_0.field_0.vx) & 0xFFFF) +
                                                      ((Q8_TO_Q4(g_MapOverlayHeader.unkTable1_4C[arg1].vy_8 + ptr->field_16C[ptr->field_1D8].vy) - ptr->field_0.field_0.vy) << 16));

            (&ptr->field_14C[ptr->field_1D8])->vz = Q8_TO_Q4(g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 + ptr->field_16C[ptr->field_1D8].vz)- ptr->field_0.field_0.vz;
        }
        ...
        *(s32*)&(*poly)->u0 = g_MapOverlayHeader.unkTable1_4C[arg1].field_B ? 0xD380FF : 0xD380E0;
        *(s32*)&(*poly)->u1 = (g_MapOverlayHeader.unkTable1_4C[arg1].field_B ? 0xFF : 0xE0) +
                              (g_MapOverlayHeader.unkTable1_4C[arg1].field_B ? 0x2B7FE1 : 0x2B801F);
        *(u16*)&(*poly)->u2 = g_MapOverlayHeader.unkTable1_4C[arg1].field_B ? 0x9FFF : 0x9FE0;
        *(u16*)&(*poly)->u3 = (g_MapOverlayHeader.unkTable1_4C[arg1].field_B ? 0xFF : 0xE0) -
...
bool func_80064334(POLY_FT4** poly, s32 arg1) // 0x80064334
{
    s32              temp_s0;
    s32              temp_s4;
    s32              temp_v0_2;
    ...
    if (g_MapOverlayHeader.unkTable1_4C[arg1].field_A == 20)
    {
        ptr->field_164 = 0xCC;
        ptr->field_168 = 0x666;
    }
    else if (g_MapOverlayHeader.unkTable1_4C[arg1].field_A == 21)
    {
        ptr->field_164 = 0xCC;
        ptr->field_168 = 0x666;
    }
    ...
    *(s32*)&ptr->field_138 = (((g_MapOverlayHeader.unkTable1_4C[arg1].vx_0 >> 4) - (u16)ptr->field_0.field_0.vx) & 0xFFFF) +
                             ((((g_MapOverlayHeader.unkTable1_4C[arg1].vy_8) >> 4) - ptr->field_0.field_0.vy) << 16);
    ptr->field_138.vz      = (g_MapOverlayHeader.unkTable1_4C[arg1].vz_4 >> 4) - ptr->field_0.field_0.vz;
    ...
    *(s32*)&(*poly)->u0 = (((g_MapOverlayHeader.unkTable1_4C[arg1].field_B << 5) + 160) << 8) + 0x011300E0;
    *(s32*)&(*poly)->u1 = (((g_MapOverlayHeader.unkTable1_4C[arg1].field_B << 5) + 160) << 8) + 0x2B00FF;
...
// Used to overwrite `HARRY_BASE_ANIM_INFOS` when certain weapons are equipped?
const s_AnimInfo D_80028B94[] = {
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(25.0f) }, 568, 577 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 579 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(20.0f) }, 579, 598 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 599 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(18.0f) }, 599, 615 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 616 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(20.0f) }, 616, 635 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 577 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(-35.0f) }, 568, 577 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(40.0f) }, 568, 579 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 584 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(22.0f) }, 584, 613 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 614 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(16.0f) }, 614, 634 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 637 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(18.0f) }, 637, 659 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 579 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(-35.0f) }, 568, 579 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(45.0f) }, 568, 579 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 584 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(25.0f) }, 584, 613 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 614 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(16.0f) }, 614, 634 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 637 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(20.0f) }, 637, 659 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 579 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(-40.0f) }, 568, 579 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(30.0f) }, 568, 575 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 581 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(20.0f) }, 581, 595 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 596 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(16.0f) }, 596, 611 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 613 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(16.0f) }, 613, 629 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 577 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(-40.0f) }, 568, 577 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(30.0f) }, 568, 579 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 580 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(25.0f) }, 580, 597 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 598 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(16.0f) }, 598, 611 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 615 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(16.0f) }, 615, 625 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 579 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(-35.0f) }, 568, 579 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(15.0f) }, 568, 583 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 584 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(16.0f) }, 584, 602 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 603 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(14.0f) }, 603, 618 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 619 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(14.0f) }, 619, 637 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 649 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(-35.0f) }, 638, 649 },
    { Anim_Update2, ANIM_STATUS(33, false), false, ANIM_STATUS(33, true), { Q12(100.0f) }, NO_VALUE, 638 },
    { Anim_Update0, ANIM_STATUS(33, true), false, ANIM_STATUS(33, true), { Q12(24.0f) }, 638, 649 },
    { Anim_Update2, ANIM_STATUS(34, false), false, ANIM_STATUS(34, true), { Q12(100.0f) }, NO_VALUE, 650 },
    { Anim_Update1, ANIM_STATUS(34, true), false, NO_VALUE, { Q12(20.0f) }, 650, 655 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(18.0f) }, 568, 583 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 584 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(24.0f) }, 584, 597 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 598 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(20.0f) }, 598, 611 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 612 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(22.0f) }, 612, 625 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 636 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(-25.0f) }, 626, 636 },
    { Anim_Update2, ANIM_STATUS(33, false), false, ANIM_STATUS(33, true), { Q12(100.0f) }, NO_VALUE, 626 },
    { Anim_Update0, ANIM_STATUS(33, true), false, ANIM_STATUS(33, true), { Q12(23.0f) }, 626, 636 },
    { Anim_Update2, ANIM_STATUS(34, false), false, ANIM_STATUS(34, true), { Q12(100.0f) }, NO_VALUE, 637 },
    { Anim_Update1, ANIM_STATUS(34, true), false, NO_VALUE, { Q12(24.0f) }, 637, 640 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 570 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(35.0f) }, 570, 579 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 582 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(40.0f) }, 582, 592 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 594 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(25.0f) }, 594, 604 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 605 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(30.0f) }, 605, 658 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 570 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(60.0f) }, 570, 592 },
    { Anim_Update2, ANIM_STATUS(33, false), false, ANIM_STATUS(33, true), { Q12(100.0f) }, NO_VALUE, 579 },
    { Anim_Update0, ANIM_STATUS(33, true), false, ANIM_STATUS(33, true), { Q12(-35.0f) }, 570, 579 },
    { Anim_Update2, ANIM_STATUS(34, false), false, ANIM_STATUS(34, true), { Q12(100.0f) }, NO_VALUE, 592 },
    { Anim_Update0, ANIM_STATUS(34, true), false, ANIM_STATUS(34, true), { Q12(-35.0f) }, 580, 592 },
    { Anim_Update2, ANIM_STATUS(35, false), false, ANIM_STATUS(35, true), { Q12(100.0f) }, NO_VALUE, 592 },
    { Anim_Update0, ANIM_STATUS(35, true), false, ANIM_STATUS(35, true), { Q12(-30.0f) }, 570, 592 },
    { Anim_Update2, ANIM_STATUS(36, false), false, ANIM_STATUS(36, true), { Q12(100.0f) }, NO_VALUE, 582 },
    { Anim_Update0, ANIM_STATUS(36, true), false, ANIM_STATUS(36, true), { Q12(25.0f) }, 582, 604 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(35.0f) }, 568, 587 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 588 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(25.0f) }, 588, 597 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 598 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(16.0f) }, 598, 607 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 608 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(20.0f) }, 608, 642 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 588 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(25.0f) }, 588, 597 },
    { Anim_Update2, ANIM_STATUS(33, false), false, ANIM_STATUS(33, true), { Q12(100.0f) }, NO_VALUE, 597 },
    { Anim_Update0, ANIM_STATUS(33, true), false, ANIM_STATUS(33, true), { Q12(-30.0f) }, 588, 597 },
    { Anim_Update2, ANIM_STATUS(34, false), false, ANIM_STATUS(34, true), { Q12(100.0f) }, NO_VALUE, 597 },
    { Anim_Update0, ANIM_STATUS(34, true), false, ANIM_STATUS(34, true), { Q12(-30.0f) }, 597, 597 },
    { Anim_Update2, ANIM_STATUS(35, false), false, ANIM_STATUS(35, true), { Q12(100.0f) }, NO_VALUE, 587 },
    { Anim_Update0, ANIM_STATUS(35, true), false, ANIM_STATUS(35, true), { Q12(-22.0f) }, 568, 587 },
    { Anim_Update2, ANIM_STATUS(36, false), false, ANIM_STATUS(36, true), { Q12(100.0f) }, NO_VALUE, 598 },
    { Anim_Update0, ANIM_STATUS(36, true), false, ANIM_STATUS(36, true), { Q12(16.0f) }, 598, 607 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 570 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(40.0f) }, 570, 579 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 582 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(30.0f) }, 582, 592 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 594 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(22.0f) }, 594, 604 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 605 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(17.0f) }, 605, 641 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 570 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(60.0f) }, 570, 592 },
    { Anim_Update2, ANIM_STATUS(33, false), false, ANIM_STATUS(33, true), { Q12(100.0f) }, NO_VALUE, 579 },
    { Anim_Update0, ANIM_STATUS(33, true), false, ANIM_STATUS(33, true), { Q12(-40.0f) }, 570, 579 },
    { Anim_Update2, ANIM_STATUS(34, false), false, ANIM_STATUS(34, true), { Q12(100.0f) }, NO_VALUE, 592 },
    { Anim_Update0, ANIM_STATUS(34, true), false, ANIM_STATUS(34, true), { Q12(-40.0f) }, 580, 592 },
    { Anim_Update2, ANIM_STATUS(35, false), false, ANIM_STATUS(35, true), { Q12(100.0f) }, NO_VALUE, 592 },
    { Anim_Update0, ANIM_STATUS(35, true), false, ANIM_STATUS(35, true), { Q12(-20.0f) }, 570, 592 },
    { Anim_Update2, ANIM_STATUS(36, false), false, ANIM_STATUS(36, true), { Q12(100.0f) }, NO_VALUE, 582 },
    { Anim_Update0, ANIM_STATUS(36, true), false, ANIM_STATUS(36, true), { Q12(22.0f) }, 582, 604 },
    { Anim_Update2, ANIM_STATUS(28, false), false, ANIM_STATUS(28, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(28, true), false, ANIM_STATUS(28, true), { Q12(24.0f) }, 568, 574 },
    { Anim_Update2, ANIM_STATUS(29, false), false, ANIM_STATUS(29, true), { Q12(100.0f) }, NO_VALUE, 574 },
    { Anim_Update0, ANIM_STATUS(29, true), false, ANIM_STATUS(29, true), { Q12(20.0f) }, 574, 574 },
    { Anim_Update2, ANIM_STATUS(30, false), false, ANIM_STATUS(30, true), { Q12(100.0f) }, NO_VALUE, 575 },
    { Anim_Update0, ANIM_STATUS(30, true), false, ANIM_STATUS(30, true), { Q12(20.0f) }, 575, 579 },
    { Anim_Update2, ANIM_STATUS(31, false), false, ANIM_STATUS(31, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(31, true), false, ANIM_STATUS(31, true), { Q12(17.0f) }, 568, 568 },
    { Anim_Update2, ANIM_STATUS(32, false), false, ANIM_STATUS(32, true), { Q12(100.0f) }, NO_VALUE, 568 },
    { Anim_Update0, ANIM_STATUS(32, true), false, ANIM_STATUS(32, true), { Q12(24.0f) }, 568, 574 },
    { Anim_Update2, ANIM_STATUS(33, false), false, ANIM_STATUS(33, true), { Q12(100.0f) }, NO_VALUE, 574 },
    { Anim_Update0, ANIM_STATUS(33, true), false, ANIM_STATUS(33, true), { Q12(-20.0f) }, 568, 574 },
    { Anim_Update2, ANIM_STATUS(34, false), false, ANIM_STATUS(34, true), { Q12(100.0f) }, NO_VALUE, 574 },
    { Anim_Update0, ANIM_STATUS(34, true), false, ANIM_STATUS(34, true), { Q12(-20.0f) }, 574, 574 },
    { Anim_Update2, ANIM_STATUS(35, false), false, ANIM_STATUS(35, true), { Q12(100.0f) }, NO_VALUE, 574 },
    { Anim_Update0, ANIM_STATUS(35, true), false, ANIM_STATUS(35, true), { Q12(-20.0f) }, 568, 574 },
    { Anim_Update2, ANIM_STATUS(36, false), false, ANIM_STATUS(36, true), { Q12(100.0f) }, NO_VALUE, 574 },
    { Anim_Update0, ANIM_STATUS(36, true), false, ANIM_STATUS(36, true), { Q12(20.0f) }, 574, 579 }
};

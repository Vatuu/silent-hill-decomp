        ...
        case 2:
            ...
            if (g_Controller0->btnsClicked_10 & g_GameWorkPtr->config_0.controllerConfig_0.enter_0)
            {
                ...
                else
                {
                    ...
                    if (D_800C444C < 0)
                    {
                        D_800C444C = FP_TO(CLAMP_LOW_THEN_MIN((s16)temp_s0_2 + 0x50, 0, 0xA0), Q12_SHIFT);
                        D_800C4450 = FP_TO(CLAMP_LOW_THEN_MIN((temp_s0_2 >> 16) + 0x3C, 0, 0x78), Q12_SHIFT);
                    }
                }
            }
                  ...
                  s_IpdCollisionData** collDataPtrs, s32 collDataIdx, s_func_8006CF18* arg6, s32 arg7, s_SubCharacter** charas, s32 charaCount) // 0x8006A4A8
{
    ...
    func_8006A940(pos, arg2, charas, charaCount);

...
void func_80070B84(s_SubCharacter* chara, s32 arg1, s32 arg2, s32 arg3) // 0x80070B84
{
    ...
    { 
        ...
        {
            temp_v0                                                                 = g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 - ((Math_DeltaTimeDistScale(FP_METER(0.4f))) * 2);
        ...
        else if (g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 < arg1)
        {
            ...
            {
                g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 = *new_var + Math_DeltaTimeDistScale(FP_TIME(0.4f));
            }
...
void func_80070DF0(s_MainCharacterExtra* extra, s_SubCharacter* chara, s32 arg2, s32 animStatus)  // 0x80070DF0
{
    ...
    temp_a1 = QX_12_FRACT(ratan2((g_SysWork.npcs_1A0[g_SysWork.enemyTargetIdx_2353].position_18.vx + g_SysWork.npcs_1A0[g_SysWork.enemyTargetIdx_2353].field_D8.field_0) - g_SysWork.playerCombatInfo_38.field_0.vx, 
                                 (g_SysWork.npcs_1A0[g_SysWork.enemyTargetIdx_2353].position_18.vz + g_SysWork.npcs_1A0[g_SysWork.enemyTargetIdx_2353].field_D8.field_2) - g_SysWork.playerCombatInfo_38.field_0.vz) + 0x1000);
    ...
    if (extra->model_0.anim_4.keyframeIdx_8 >= (HARRY_BASE_ANIM_INFOS[animStatus].startKeyframeIdx_C + D_800AD4C8[arg2].field_E) && 
        HARRY_BASE_ANIM_INFOS[animStatus].startKeyframeIdx_C + D_800AD4C8[arg2].field_E + D_800AD4C8[arg2].field_F >= extra->model_0.anim_4.keyframeIdx_8)
    {
    ...
    switch (g_SysWork.player_4C.extra_128.state_1C)
    {
        ...
        case PlayerState_GetUpBack:
            if (g_SysWork.player_4C.extra_128.state_1C != PlayerState_FallBackward)
            {
                if (g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 != 0)
                {
                    g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 -= Math_DeltaTimeDistScale(FP_METER(0.4f)) >> 1;
            ...
            {
                g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 -= Math_DeltaTimeDistScale(FP_METER(0.4f)) >> 2;
        ...
        case PlayerState_Death: 
            ...
            if (IS_ANIM_STATUS_ACTIVE(chara->model_0.anim_4.status_0))
            {
                ...
                temp_s0_3                                    = temp_a2 + FP_MULTIPLY(var_v1_5 - temp_a2, QX_12_FRACT(chara->model_0.anim_4.time_4), Q12_SHIFT);
                g_SysWork.player_4C.chara_0.field_D8.field_0 = 0;
                g_SysWork.player_4C.chara_0.field_D8.field_2 = 0;
        ...
        case PlayerState_InstantDeath:
            ...
            if (chara->model_0.anim_4.keyframeIdx_8 == g_MapOverlayHeader.field_38[D_800AF220].field_6 - 0x19)
            {
                g_MapOverlayHeader.func_DC();
...
bool Player_UpperBodyMainUpdate(s_SubCharacter* chara, s_MainCharacterExtra* extra) // 0x80075504
{
    ...
    bool Player_CombatAnimUpdate() // 0x80074350
    {
        ...
        if (extra->model_0.state_2 == 0)
        {
            ...
            D_800C44D0 = HARRY_BASE_ANIM_INFOS[g_Player_AttackAnimIdx].startKeyframeIdx_C + D_800AD4C8[g_SysWork.playerCombatInfo_38.equippedWeapon_F].field_E;
            D_800C44D4 = HARRY_BASE_ANIM_INFOS[g_Player_AttackAnimIdx].startKeyframeIdx_C + D_800AD4C8[g_SysWork.playerCombatInfo_38.equippedWeapon_F].field_E +
        ...
        if (g_SysWork.enemyTargetIdx_2353 != NO_VALUE && g_SysWork.playerCombatInfo_38.equippedWeapon_F >= EquippedWeaponId_Handgun)
        {
            ...
            {
                chara->rotation_24.pad = QX_12_FRACT(ratan2((g_SysWork.npcs_1A0[enemyAttackedIdx].position_18.vx + g_SysWork.npcs_1A0[enemyAttackedIdx].field_D8.field_0) - g_SysWork.player_4C.chara_0.position_18.vx,
        ...
        else
        {
            if (g_SysWork.enemyTargetIdx_2353 != NO_VALUE && !g_GameWork.config_0.optExtraAutoAiming_2C)
            {
                ...
                if (enemyAttackedIdx == g_SysWork.enemyTargetIdx_2353)
                {
                    temp_a1 = QX_12_FRACT(ratan2((g_SysWork.npcs_1A0[enemyAttackedIdx].position_18.vx + g_SysWork.npcs_1A0[enemyAttackedIdx].field_D8.field_0) - g_SysWork.player_4C.chara_0.position_18.vx,
                                                (g_SysWork.npcs_1A0[enemyAttackedIdx].position_18.vz + g_SysWork.npcs_1A0[enemyAttackedIdx].field_D8.field_2) - g_SysWork.player_4C.chara_0.position_18.vz) + 0x1000);
    ...
    switch (g_SysWork.player_4C.extra_128.lowerBodyState_24)
    {
        ...
        case PlayerLowerBodyState_RunForward:
            ...
            if (g_Controller0->sticks_20.sticks_0.leftY <= -STICK_THRESHOLD)
            {
                ...
                {
                    var_a3 = Math_DeltaTimeDistScale(FP_METER(0.75f));
                } 
                else 
                {
                    temp   = g_DeltaTime0;
                ...
                func_80070CF0(chara, FP_FLOAT_TO(2.0f, Q12_SHIFT), var_a2, var_a3, Math_DeltaTimeDistScale(FP_METER(0.4f)));
            }
            // Stopped running.
            else
            {
        ...
        case PlayerLowerBodyState_RunRight:
            ...
            {
                g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 += Math_DeltaTimeDistScale(FP_METER(0.75f));
                g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126  = CLAMP(g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126,
                                                                                                 FP_METER(0.0f),
                                                                                                 FP_METER(3.1739));
            }
            ...
            if (g_SysWork.player_4C.extra_128.upperBodyState_20 != PlayerUpperBodyState_AimStartTargetLock)
            {
                switch (temp_s3)
                {
                    ...
                    default:
                        ...
                        else if (chara->model_0.anim_4.status_0 == ANIM_STATUS(PlayerAnim_RunLeft, true) && chara->model_0.anim_4.keyframeIdx_8 >= 132 &&
        ...
        case PlayerLowerBodyState_AimQuickTurnRight:
            ...
            if (chara->model_0.anim_4.status_0 == ANIM_STATUS(PlayerAnim_QuickTurnRight, true) && chara->model_0.anim_4.keyframeIdx_8 >= 206)
            {
        ...
        case PlayerLowerBodyState_AimQuickTurnLeft:
            ...
            if (chara->model_0.anim_4.status_0 == ANIM_STATUS(PlayerAnim_QuickTurnLeft, true) && chara->model_0.anim_4.keyframeIdx_8 >= 219)
            {
                D_800C454C = -(g_DeltaTime0 * 24);
            }
            else
        ...
        case PlayerLowerBodyState_JumpBackward:
            ...
            if (chara->model_0.anim_4.status_0 == ANIM_STATUS(PlayerAnim_JumpBackward, true) && chara->model_0.anim_4.keyframeIdx_8 == 246)
            {
        ...
        case PlayerLowerBodyState_Stumble:
            if (g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 != FP_METER(0.0f))
            {
                g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 -= ((Math_DeltaTimeDistScale(FP_METER(0.4f))) * 2) / 3;
                if ((g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 >> 16) & (1 << 0))
                {
                    g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 = FP_METER(0.0f);
                }
            ...
            {
                g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 -= (Math_DeltaTimeDistScale(FP_METER(0.4f))) * 4;
                if ((g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 >> 16) & (1 << 0))
                {
                    g_SysWork.player_4C.chara_0.properties_E4.player.playerMoveDistance_126 = FP_METER(0.0f);
                }
            ...
            if (chara->model_0.anim_4.status_0 == ANIM_STATUS(PlayerAnim_RunForwardStumble, true) && chara->model_0.anim_4.keyframeIdx_8 == 179)
            {
                g_SysWork.player_4C.extra_128.lowerBodyState_24 = PlayerLowerBodyState_None;
        ...
        case PlayerLowerBodyState_RunLeftStumble:
            ...
            if (chara->model_0.anim_4.status_0 == ANIM_STATUS(PlayerAnim_RunLeftStumble, true) && chara->model_0.anim_4.keyframeIdx_8 == 349)
            {
                g_SysWork.player_4C.extra_128.lowerBodyState_24 = PlayerLowerBodyState_None;
        ...
        case PlayerLowerBodyState_RunRightStumble:
            ...
            if (chara->model_0.anim_4.status_0 == ANIM_STATUS(PlayerAnim_RunRightStumble, true) && chara->model_0.anim_4.keyframeIdx_8 == 378)
            {
                g_SysWork.player_4C.extra_128.lowerBodyState_24 = PlayerLowerBodyState_None;
        ...
        case PlayerLowerBodyState_Attack:
                 ...
                 (g_SysWork.playerCombatInfo_38.equippedWeapon_F % 10) != EquippedWeaponId_Katana))
            {
                if (IS_ANIM_STATUS_ACTIVE(chara->model_0.anim_4.status_0) && IS_ANIM_STATUS_ACTIVE(extra->model_0.anim_4.status_0) &&
                    (chara->model_0.anim_4.status_0 >= ANIM_STATUS(PlayerAnim_Unk29, false) || chara->model_0.anim_4.keyframeIdx_8 == D_800C44F0[0].field_6))
                {
                    if (!g_Player_IsMovingForward)
                    {
                        if (g_Player_IsMovingBackward)
...
void func_8007D090(s_SubCharacter* chara, s_MainCharacterExtra* extra, GsCOORDINATE2* coord) // 0x8007D090
{
    ...
    switch (g_SysWork.player_4C.extra_128.state_1C)
    {
        ...
        case PlayerState_None:
            ...
            temp_a1_3 = Math_DeltaTimeDistScale(24);
...
void func_8007D970(s_SubCharacter* chara, GsCOORDINATE2* coord) // 0x8007D970
{
        ...
        ((u32)g_SysWork.player_4C.extra_128.state_1C < PlayerState_Idle || g_SysWork.player_4C.extra_128.state_1C == PlayerState_KickEnemy || g_SysWork.player_4C.extra_128.state_1C == PlayerState_StompEnemy))
    {
        ...
        if (g_SysWork.playerCombatInfo_38.equippedWeapon_F == EquippedWeaponId_HyperBlaster &&
            g_SysWork.playerCombatInfo_38.isAiming_13 &&
            model->anim_4.status_0 >= ANIM_STATUS(PlayerAnim_HandgunAim, true) && model->anim_4.keyframeIdx_8 >= 574)
        {
...
void Player_Controller() // 0x8007F32C
{
    ...
    if (g_SysWork.playerCombatInfo_38.equippedWeapon_F >= EquippedWeaponId_Handgun && // Weapon is gun.
	    g_SysWork.player_4C.extra_128.lowerBodyState_24 >= PlayerLowerBodyState_Aim)
    {

...
{
    Collision_TriggerZonesUpdate(g_SysWork.playerWork_4C.player_0.position_18.vx, g_SysWork.playerWork_4C.player_0.position_18.vz, g_WorldGfxWork.triggerZone_1BD8);
};

...
void func_800904F4() // 0x800904F4
{
    ...
    g_SavegamePtr->field_27A               = ((D_800C48B2 & 0x10) * 8) + 0x40;
    g_SavegamePtr->isTitleYellowFlag_25C_0 = 1;
    g_SavegamePtr->mapOverlayIdx_A4        = 1;
    
    if (D_800C48B6 != 0)
    {
        g_SavegamePtr->eventFlags_168[1] |= 0x20000000;
    }
    
    if (D_800C48B7 != 0)
    {
        g_SavegamePtr->eventFlags_168[5] |= 0x800000;
    }
    
    g_SavegamePtr->eventFlags_168[1] |= 0x40000000;
    
    extraOptions = g_GameWork.config_0.optExtraOptionsEnabled_27;
    
    if ((extraOptions & 3) && (extraOptions & 0xC))
    {
        g_SavegamePtr->eventFlags_168[1] |= 0x02000000;
    }
    
    if (g_GameWork.config_0.optExtraOptionsEnabled_27 & 1)
    {
        g_SavegamePtr->eventFlags_168[1] |= 0x04000000;
    }

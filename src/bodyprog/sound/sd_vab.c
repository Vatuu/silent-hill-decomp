 ...
 * 3 = Music VAB.
 *
 * This types are irregular as the first 3 defined files at `D_800A9FEC` doesn't correspond to their
 * categories, maybe the last two which one is unused and the other is the sound that plays when starting
 * a save, but the first file has a 0 value which means is a KDT file however it's actually a VAB file

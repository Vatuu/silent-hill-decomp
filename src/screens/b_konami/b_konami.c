...
/** TODO
Solve the issues related to the padding of the
jump table generated by func_800C99A4
*/
...
void func_800C9E6C(s_FsImageDesc* image, s32 otz, s32 vramX, s32 vramY, s32 w, s32 h, s32 x, s32 y) // 0x800C9E6C
{
    ...
    *(u32*)(&prim->u0) = vramX + (vramY << 8) + (((image->clutY << 6) | ((image->clutX >> 4) & 0x3F)) << 0x10);
    ...
    setDrawTPage(tpage, 0, 1, getTPage(*((u8*)&image->tPage), 0, (vramBase << 6), ((vramBase >> 4 & 0x1) << 8)));
...
/** This is here to grab the padding that
should be generated by the jumptable, but
on this case is not being generated.
*/
const s32 rodata_padding = 0;

void func_800CA2C8(s32 arg0) // 0x800CA2C8
{
    static const s32 time_var_0 = 25; // 0x19
    static const s32 time_var_1 = 180; // 0xB4
    ...
    expected_time = (arg0 * 263) - time_var_0;

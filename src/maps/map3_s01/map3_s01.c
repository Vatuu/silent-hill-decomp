...
void MapEvent_UseBottleOnLiquid(void) // 0x800D25A8
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case EventState_SfxId:
            func_8005DC1C(Sfx_Unk1493, &QVECTOR3(141.6f, -0.0999f, 20.75f), Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
...
void MapEvent_Generator0(void) // 0x800D27C8
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case EventState_PressSwitch:
            func_8005DC1C(Sfx_Unk1494, &QVECTOR3(140.5f, -0.5f, -20.6f), Q8(0.5f), SfxFlag_None);
            SD_Call(Sfx_Unk1495);
...
void func_800D2A88(void) // 0x800D2A88
{
    ...
    {
        func_8005DC1C(Sfx_MenuMap, &QVECTOR3(61.72f, -0.8f, 100.5098f), Q8(0.5f), SfxFlag_None);
    }

...
INCLUDE_ASM("asm/maps/map1_s00/nonmatchings/map1_s00", AI_LarvalStalker_Update); // 0x800CF050
...
INCLUDE_ASM("asm/maps/map1_s00/nonmatchings/map1_s00", AI_Stalker_Update); // 0x800D24F8

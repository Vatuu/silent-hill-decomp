...
u8 Map_RoomIdxGet(s32 x, s32 z) // 0x800D6508
{
    ...
    if (x >= Q12(-40.0f))
    {
        if (CheckRange(x + Q12(-20.0f), Q12(-4.0f), Q12(4.0f)))
        {
            if (z > Q12(-8.0f))
            {
                res = 1;
        ...
        {
        block_6:
            if (CheckRange(z + Q12(12.0f), Q12(-4.0f), Q12(4.0f)))
            {
                if (CheckRange(x + Q12(-40.0f), Q12(-8.0f), Q12(8.0f)))
                {
                    res = 3;
                }
                else
            ...
            {
            block_10:
                if (CheckRange(x + Q12(-52.0f), Q12(-4.0f), Q12(4.0f)) &&
                    CheckRange(z + Q12(40.0f), Q12(-8.0f), Q12(8.0f)))
                {
                    res = 4;
                }
            }
    ...
    else if (CheckRange(x + Q12(60.0f), Q12(-4.0f), Q12(4.0f)))
    {
        if (z > Q12(-8.0f))
        {
            res = 9;
        }
        else if (CheckRange(z + Q12(52.0f), Q12(-36.0f), Q12(36.0f)))
        {
            res = 8;
        }
    }
    ...
    {
    block_22:
        if ((u32)(z + Q12(94.0f)) <= (u32)Q12(4.0f))
        {
            if (x > Q12(-89.0f))
            {
                res = 11;
        ...
        {
        block_26:
            if (CheckRange(x + Q12(92.0f), Q12(-4.0f), Q12(4.0f)) &&
                CheckRange(z + Q12(46.0f), Q12(-30.0f), Q12(30.0f)))
            {
                res = 13;
            }
        }
    ...
    if (res == 0)
    {
        if ((u32)(x + Q12(120.0f)) > (u32)(Q12(200.0f) - 1) ||
            z < Q12(-120.0f) || z > Q12(80.0f) - 1)
        {
            res = 0;
        }
        else
        {
            x = (x + Q12(120.0f)) / CHUNK_CELL_SIZE;
            z = (z + Q12(120.0f)) / CHUNK_CELL_SIZE;

            res = MAP_ROOM_IDXS[(x * 5) + z];
        }
    }

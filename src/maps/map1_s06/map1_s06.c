...
void Map_WorldObjectsInit(void) // 0x800D63D8
{
    ...
    WorldObjectInit(&D_800DAFB4, 20.9021f, -0.002f, -17.26f, 0.0f, -37.45f, 0.0f);
    ...
    WorldObjectInit(&D_800DAFF4, 61.8531f, -0.805f, 140.61f, 0, 92.9f, 0.0f);
    WorldObject_ModelNameSet(&D_800DAFF4.object_0, D_800A99E4.savePadName_4);

    WorldObjectInit(&D_800DB024, 133.294f, -0.8614f, 19.04f, 0.0f, 162.6f, 0.0f);
    WorldObject_ModelNameSet(&D_800DB024.object_0, "PICT00_H");

    WorldObjectInit(&D_800DB064, 96.9405f, -0.3365f, 21.092f, 0.0f, 66.8f, 0.0f);

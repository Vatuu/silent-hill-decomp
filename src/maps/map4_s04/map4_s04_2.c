...
void func_800D1910(void) // 0x800D1910
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 4:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(8.0f), Q12(0.0f), Q12(23.0f), true, false);
            break;
        ...
        case 11:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(25.0f), Q12(46.0f), true, false);
    ...
    if (g_CutsceneTimer >= Q12(0.0f))
    {
        ...
        if (D_800D37C0 != 0)
        {
            Dms_CharacterTransformGet(&g_SysWork.npcs[0].position, &g_SysWork.npcs[0].rotation, "LISA", g_CutsceneTimer, (s_DmsHeader*)FS_BUFFER_15);
        }
...
void func_800D23E4(void) // 0x800D23E4
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 4:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(6.5f), Q12(0.0f), Q12(20.0f), true, false);
            break;

        case 5:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(6.5f), Q12(0.0f), Q12(20.0f), true, true);
            break;
        ...
        case 7:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(8.0f), Q12(21.0f), Q12(54.0f), true, false);

            if (g_CutsceneTimer >= Q12(32.0f) && D_800D37C1 == 0)
            {
        ...
        case 8:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(8.0f), Q12(21.0f), Q12(54.0f), true, true);
        ...
        case 18:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(58.0f), Q12(126.0f), true, false);
            break;

        case 19:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(58.0f), Q12(126.0f), true, true);
            break;
        ...
        case 21:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(127.0f), Q12(151.0f), false, true);
            break;
        ...
        case 23:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(127.0f), Q12(160.0f), false, true);
            break;
        ...
        case 25:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(127.0f), Q12(200.0f), true, true);
            break;
    ...
    if (g_CutsceneTimer >= Q12(0.0f))
    {
        ...
        Dms_CharacterTransformGet(&g_SysWork.npcs[0].position, &g_SysWork.npcs[0].rotation, "LISA", g_CutsceneTimer, FS_BUFFER_15);
        ...
        Dms_CharacterTransformGet(&g_SysWork.pointLightPosition, &unused, "LIGHT", g_CutsceneTimer, FS_BUFFER_15);

        // "L_INT", interior light or intersection point?
        Dms_CharacterTransformGet(&lightIntPos, &unused, "L_INT", g_CutsceneTimer, FS_BUFFER_15);

...
#include "maps/shared/sharedFunc_800CEFF4_0_s00.h" // 0x800CC07C
...
#include "maps/shared/sharedFunc_800D0690_1_s03.h" // 0x800CCBC0
...
#include "maps/shared/sharedFunc_800D3308_0_s00.h" // 0x800CF414

#include "maps/shared/Ai_Stalker_ControlUpdate.h" // 0x800CFC50

void Ai_Stalker_Control_2(s_SubCharacter* chara) {} // 0x800D0000

#include "maps/shared/Ai_Stalker_Control_3.h" // 0x800D0008

#include "maps/shared/Ai_Stalker_Control_4.h" // 0x800D0BD8

#include "maps/shared/Ai_Stalker_Control_5.h" // 0x800D1344

#include "maps/shared/Ai_Stalker_Control_6.h" // 0x800D1754

#include "maps/shared/Ai_Stalker_Control_7.h" // 0x800D1DF4

#include "maps/shared/Ai_Stalker_Control_8.h" // 0x800D1F10

#include "maps/shared/Ai_Stalker_Control_9.h" // 0x800D2278

#include "maps/shared/Ai_Stalker_Control_10.h" // 0x800D267C

#include "maps/shared/Ai_Stalker_Control_11.h" // 0x800D27F8

#include "maps/shared/Ai_Stalker_Control_12.h" // 0x800D2800

#include "maps/shared/Ai_Stalker_Control_13.h" // 0x800D29B8

#include "maps/shared/sharedFunc_800D67FC_0_s00.h" // 0x800D2AA8

#include "maps/shared/sharedFunc_800D6970_0_s00.h" // 0x800D2C1C

#include "maps/shared/sharedFunc_800D70C4_0_s00.h" // 0x800D3370
...
INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_3); // 0x800D4C7C

INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_4); // 0x800D5284

INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_5); // 0x800D5544

INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_6); // 0x800D56F8

INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_7); // 0x800D58B4

INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_8); // 0x800D5FEC

INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_9); // 0x800D6110
...
INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_12); // 0x800D64C4

INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_13); // 0x800D6680

INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_14); // 0x800D67C0

INCLUDE_ASM("asm/maps/map6_s03/nonmatchings/map6_s03", Ai_HangedScratcher_Control_15); // 0x800D6A20
...
void func_800D84EC(void) // 0x800D84EC
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        case 4:
            g_SysWork.playerWork_4C.player_0.position_18.vy -= FP_MULTIPLY_FLOAT_PRECISE(g_DeltaTime0, 0.415f, 12);
            SysWork_StateStepIncrementDelayed(Q12(5.0f), false);
            break;

        case 5:
            SysWork_StateStepIncrementAfterFade(2, true, 0, Q12(1.5f), false);
            g_SysWork.playerWork_4C.player_0.position_18.vy -= FP_MULTIPLY_FLOAT_PRECISE(g_DeltaTime0, 0.41f, 12);
            break;

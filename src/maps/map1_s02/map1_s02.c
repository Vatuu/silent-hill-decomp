...
INCLUDE_ASM("asm/maps/map1_s02/nonmatchings/map1_s02", AI_Stalker_Update); // 0x800D2948
...
INCLUDE_ASM("asm/maps/map1_s02/nonmatchings/map1_s02", AI_Creaper_Update); // 0x800D7B98

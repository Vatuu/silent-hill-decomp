...
void Map_RoomBgmInit(bool arg0) // 0x800EAD0C
{
    s32 var_s1;
    s32 var_s2;
    s32 temp_a2;
    ...
    D_800EFD04   += g_DeltaTime0;
    D_800EFCFC[2] = Q12_MULT_PRECISE(var_s2, (Math_Sin(D_800EFD04 / 12) + Q12(3.0f)) / 4);

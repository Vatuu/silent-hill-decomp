...
INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DC0E4_2_s00); // 0x800DBAA0
...
INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DC50C_2_s00); // 0x800DBEC8
...
INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DC98C_2_s00); // 0x800DC348
...
INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DD13C_2_s00); // 0x800DCAF8

INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DD2C4_2_s00); // 0x800DCC80
...
INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DE940_2_s00); // 0x800DE2FC
...
INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DEE24_2_s00); // 0x800DE7E0
...
INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DF2D0_2_s00); // 0x800DEC8C

INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DF358_2_s00); // 0x800DED14

INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DF448_2_s00); // 0x800DEE04
...
INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800DF8A0_2_s00); // 0x800DF25C
...
INCLUDE_ASM("asm/maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800E0698_2_s00); // 0x800E0054
...
#define CUTSCENE_SKIP_STATE 19
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        case 5:
            func_80085EB8(0, &g_SysWork.player_4C.chara_0, 126, false);
        ...
        case 8:
            func_80085EB8(0, &g_SysWork.player_4C.chara_0, 133, false);
            SysWork_StateStepIncrement(0);
        ...
        case 10:
            func_80085EB8(0, &g_SysWork.player_4C.chara_0, 114, false);
        ...
        case 17:
            func_80085EB8(0, &g_SysWork.player_4C.chara_0, 127, false);
    ...
    if (D_800F0040 >= 0)
    {
        Dms_CharacterGetPosRot(&g_SysWork.player_4C.chara_0.position_18, &g_SysWork.player_4C.chara_0.rotation_24, "HERO", D_800F0040, FS_BUFFER_15);
...
void func_800EBEE0(void) // 0x800EBEE0
{
    ...
    if (PLAYER_IN_MAP_CHUNK(vz, 0, 0, -1, 1))
    {
        ...
        {
            g_WorldGfx_ObjectAdd(&g_WorldObject_Window.object_0, &g_WorldObject_Window.position_1C, &(SVECTOR3){});
        }
    }
    ...
    if (PLAYER_IN_MAP_CHUNK(vx, 1, -5, -1, -5))
    {
        if (PLAYER_IN_MAP_CHUNK(vz, 1, 4, -1, 4) || PLAYER_IN_MAP_CHUNK(vz, 1, 3, -1, 3))
        {
            ...
            {
                g_WorldGfx_ObjectAdd(&g_WorldObject_DrClose.object_0, &g_WorldObject_DrClose.position_1C, &(SVECTOR3){});
            }
        }
    }

...
#include "maps/shared/Ai_AirScreamerControl_2.h" // 0x800D35E0

#include "maps/shared/Ai_AirScreamerControl_3.h" // 0x800D3800

#include "maps/shared/Ai_AirScreamerControl_4.h" // 0x800D3960

#include "maps/shared/Ai_AirScreamerControl_5.h" // 0x800D3D14

#include "maps/shared/Ai_AirScreamerControl_6.h" // 0x800D4084

#include "maps/shared/Ai_AirScreamerControl_7.h" // 0x800D4458

#include "maps/shared/Ai_AirScreamerControl_8.h" // 0x800D4834

#include "maps/shared/Ai_AirScreamerControl_9.h" // 0x800D4C24

#include "maps/shared/Ai_AirScreamerControl_10.h" // 0x800D4F10

#include "maps/shared/Ai_AirScreamerControl_11.h" // 0x800D5330

#include "maps/shared/Ai_AirScreamerControl_12.h" // 0x800D5544

#include "maps/shared/Ai_AirScreamerControl_13.h" // 0x800D5768

#include "maps/shared/Ai_AirScreamerControl_14.h" // 0x800D59F8

#include "maps/shared/Ai_AirScreamerControl_15.h" // 0x800D5DBC

#include "maps/shared/Ai_AirScreamerControl_16.h" // 0x800D5EC0

#include "maps/shared/Ai_AirScreamerControl_17.h" // 0x800D635C

#include "maps/shared/Ai_AirScreamerControl_18.h" // 0x800D6438

#include "maps/shared/Ai_AirScreamerControl_19.h" // 0x800D67E4

#include "maps/shared/Ai_AirScreamerControl_20.h" // 0x800D6B60

#include "maps/shared/Ai_AirScreamerControl_21.h" // 0x800D6F28

#include "maps/shared/Ai_AirScreamerControl_22.h" // 0x800D7308

#include "maps/shared/Ai_AirScreamerControl_23.h" // 0x800D76C8

#include "maps/shared/Ai_AirScreamerControl_24.h" // 0x800D7AA8

#include "maps/shared/Ai_AirScreamerControl_25.h" // 0x800D7DB4

#include "maps/shared/Ai_AirScreamerControl_26.h" // 0x800D7FD4

#include "maps/shared/Ai_AirScreamerControl_27.h" // 0x800D8244

#include "maps/shared/Ai_AirScreamerControl_28.h" // 0x800D85F0

#include "maps/shared/Ai_AirScreamerControl_29.h" // 0x800D8700

#include "maps/shared/Ai_AirScreamerControl_30.h" // 0x800D8B5C

#include "maps/shared/Ai_AirScreamerControl_31.h" // 0x800D8C70

#include "maps/shared/Ai_AirScreamerControl_32.h" // 0x800D8DA4

#include "maps/shared/Ai_AirScreamerControl_33.h" // 0x800D8EA8

#include "maps/shared/Ai_AirScreamerControl_34.h" // 0x800D9298

#include "maps/shared/Ai_AirScreamerControl_35.h" // 0x800D961C

#include "maps/shared/Ai_AirScreamerControl_36.h" // 0x800D9A90

#include "maps/shared/Ai_AirScreamerControl_37.h" // 0x800D9F54

#include "maps/shared/Ai_AirScreamerControl_38.h" // 0x800DA2BC

#include "maps/shared/Ai_AirScreamerControl_39.h" // 0x800DA664

#include "maps/shared/Ai_AirScreamerControl_40.h" // 0x800DA9F4

#include "maps/shared/Ai_AirScreamerControl_41.h" // 0x800DABDC

#include "maps/shared/Ai_AirScreamerControl_42.h" // 0x800DAF08

#include "maps/shared/Ai_AirScreamerControl_43.h" // 0x800DB268

#include "maps/shared/Ai_AirScreamerControl_44.h" // 0x800DB374

#include "maps/shared/Ai_AirScreamerControl_45.h" // 0x800DB7A8
...
#include "maps/shared/sharedFunc_800DC894_2_s00.h" // 0x800DC250
...
#include "maps/shared/sharedFunc_800E012C_2_s00.h" // 0x800DFAE8

#include "maps/shared/sharedFunc_800E021C_2_s00.h" // 0x800DFBD8

#include "maps/shared/sharedFunc_800E041C_2_s00.h" // 0x800DFDD8

#include "maps/shared/sharedFunc_800E04B0_2_s00.h" // 0x800DFE6C

#include "maps/shared/sharedFunc_800E0514_2_s00.h" // 0x800DFED0
...
INCLUDE_ASM("maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800E384C_2_s00); // 0x800E30A0

#include "maps/shared/sharedFunc_800E39D8_2_s00.h" // 0x800E322C

#include "maps/shared/sharedFunc_800E3E94_2_s00.h" // 0x800E36E8

#include "maps/shared/sharedFunc_800E4830_2_s00.h" // 0x800E4084

#include "maps/shared/sharedFunc_800E4E84_2_s00.h" // 0x800E46D8
...
#include "maps/shared/sharedFunc_800E5AA4_2_s00.h" // 0x800E52F8

#include "maps/shared/sharedFunc_800E5EC4_2_s00.h" // 0x800E5718

#include "maps/shared/sharedFunc_800E6338_2_s00.h" // 0x800E5B8C

#include "maps/shared/sharedFunc_800E71E8_2_s00.h" // 0x800E6A3C
...
#include "maps/shared/sharedFunc_800E60FC_2_s02.h" // 0x800E72D0

#include "maps/shared/sharedFunc_800E6420_2_s02.h" // 0x800E75F4

#include "maps/shared/Ai_Romper_Control.h" // 0x800E78BC

#include "maps/shared/Ai_Romper_Control_1.h" // 0x800E792C

#include "maps/shared/sharedFunc_800E6878_2_s02.h" // 0x800E7A4C

INCLUDE_ASM("maps/map6_s00/nonmatchings/map6_s00", func_800E7E14);

INCLUDE_ASM("maps/map6_s00/nonmatchings/map6_s00", func_800E8714);

INCLUDE_ASM("maps/map6_s00/nonmatchings/map6_s00", func_800E8BAC);

INCLUDE_ASM("maps/map6_s00/nonmatchings/map6_s00", func_800E9210);

INCLUDE_ASM("maps/map6_s00/nonmatchings/map6_s00", func_800E932C);

#include "maps/shared/Ai_Romper_Control_8.h" // 0x800E95A8

#include "maps/shared/Ai_Romper_Control_9.h" // 0x800E964C

INCLUDE_ASM("maps/map6_s00/nonmatchings/map6_s00", func_800E9654);
...
INCLUDE_ASM("maps/map6_s00/nonmatchings/map6_s00", sharedFunc_800E8DFC_2_s02); // 0x800E9FD0

#include "maps/shared/sharedFunc_800E939C_2_s02.h" // 0x800EA570

INCLUDE_ASM("maps/map6_s00/nonmatchings/map6_s00", func_800EA688);

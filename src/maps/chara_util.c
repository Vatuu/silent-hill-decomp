...
void sharedFunc_800D88AC_0_s00(s_SubCharacter* stalker)
{
    ...
    stalker->properties_E4.player.field_F4         = Q12_ANGLE(0.0f);
    stalker->properties_E4.player.field_F0         = Q12(0.0f);
    stalker->properties_E4.player.positionY_EC     = Q12(0.0f);
    stalker->properties_E4.player.moveDistance_126 = Q12(0.0f);
}
...
bool sharedFunc_800D908C_0_s00(s32 animStatus, s_SubCharacter* chara, s32 keyframeIdx0, s32 keyframeIdx1, s32 sfxId, s32 pitch)
{
    ...
    if (chara->model_0.anim_4.keyframeIdx_8 >= keyframeIdx1)
    {
        ...
        {
            func_8005DD44(sfxId, &chara->position_18, Q8(0.5f), pitch);
        ...
        if (chara->model_0.anim_4.keyframeIdx_8 >= keyframeIdx)
        {
            if (!(chara->properties_E4.player.flags_11C & PlayerFlag_Unk13))
            {
                switch (sfxId)
                {
#if defined(MAP6_S04)
                    case Sfx_Unk1620:
                        func_8005DC1C(sfxId, &chara->position_18, Q8(0.25f), 0);
                        break;
                    ...
                    case Sfx_Unk1622:
                    case Sfx_Unk1638:
                        func_8005DC1C(sfxId, &chara->position_18, Q8(0.75f), 0);
                        break;
                    ...
                    case Sfx_Unk1594:
                        func_8005DC1C(sfxId, &chara->position_18, Q8(0.5f), 0);
                        break;
                    ...
                    case Sfx_Unk1674:
                    case Sfx_Unk1675:
                        func_8005DC1C(sfxId, &chara->position_18, Q8(1.0f / 8.0f), 0);
                        break;

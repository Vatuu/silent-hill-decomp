...
#include "maps/shared/sharedFunc_800CFE78_3_s02.h" // 0x800CFE78

#include "maps/shared/sharedFunc_800CFEAC_3_s02.h" // 0x800CFEAC

#include "maps/shared/sharedFunc_800CFEEC_3_s02.h" // 0x800CFEEC
...
void func_800D0608(void) // 0x800D0608
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        default:
            ...
            func_8003EF10(7, 7, PrimitiveType_S32, &D_800D1FBC, 0, Q12(100.0f));
            break;
    }

...
INCLUDE_ASM("asm/maps/map3_s02/nonmatchings/map3_s02", Ai_Creaper_Update); // 0x800CCA14
...
INCLUDE_ASM("asm/maps/map3_s02/nonmatchings/map3_s02", Ai_Alessa_Update); // 0x800CEC88

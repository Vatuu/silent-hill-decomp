...
#include "maps/shared/Player_ControlFreeze.h" // 0x800CC4BC
...
#include "maps/shared/sharedFunc_800D2E6C_0_s00.h" // 0x800CC9EC

#include "maps/shared/sharedFunc_800D2E74_0_s00.h" // 0x800CC9F4

#include "maps/shared/sharedFunc_800D2E7C_0_s00.h" // 0x800CC9FC

#include "maps/shared/sharedFunc_800D2E84_0_s00.h" // 0x800CCA04

#include "maps/shared/sharedFunc_800D2E8C_0_s00.h" // 0x800CCA0C

#include "maps/shared/sharedFunc_800D2E94_0_s00.h" // 0x800CCA14

#include "maps/shared/sharedFunc_800D2E9C_0_s00.h" // 0x800CCA1C
...
void Map_WorldObjectsUpdate(void)
{
    ...
    {
        g_WorldGfx_ObjectAdd(&g_WorldObject_SavePad0.object_0, &g_WorldObject_SavePad0.position_1C, &g_WorldObject_SavePad0.rotation_28);

        if (!Savegame_EventFlagGet(EventFlag_M1S02_PickupShotgun))
        {
            g_WorldGfx_ObjectAdd(&g_WorldObject_Shotgun.object_0, &g_WorldObject_Shotgun.position_1C, &g_WorldObject_Shotgun.rotation_28);
        }
    }
    ...
    if (PLAYER_IN_MAP_CHUNK(vx, 1, -3, -1, -3) && PLAYER_IN_MAP_CHUNK(vz, 1, 2, -1, 2))
    {
        ...
        g_WorldGfx_ObjectAdd(&g_WorldObject_SavePad1.object_0, &g_WorldObject_SavePad1.position_1C, &g_WorldObject_SavePad1.rotation_28);
    }
    else
    {
        D_800CF280 = 0;

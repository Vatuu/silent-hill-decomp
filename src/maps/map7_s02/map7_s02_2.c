...
void func_800DA248(void) // 0x800DA248
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 5:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 72, false);
            SysWork_StateStepIncrement(0);
        ...
        case 11:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[0], 17, false);
            SysWork_StateStepIncrement(0);
        ...
        case 15:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 155, false);
        ...
        case 17:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, g_SysWork.npcs, 18, false);
...
void func_800DAA4C(void) // 0x800DAA4C
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 1:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 156, false);
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[0], 6, false);
        ...
        case 4:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 157, false);
        ...
        case 6:
            ...
            func_8005DC1C(Sfx_Unk1336, &g_WorldObject_Door.position, Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
        ...
        case 8:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 158, false);
            Chara_ModelCharaIdClear(&g_SysWork.npcs[0], 0, 0);
            func_8005DC1C(Sfx_Unk1337, &g_WorldObject_Door.position, Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
...
void func_800DB738(void) // 0x800DB738
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 2:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 146, false);
        ...
        case 4:
            func_8005DC1C(Sfx_Unk1526, &SFX_POS, Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
        ...
        case 10:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 147, false);
            SysWork_StateStepIncrement(0);
            break;
...
void func_800DC14C(void) // 0x800DC14C
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 8:
            ...
            g_SysWork.cutsceneBorderState = 20;
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 143, false);
        ...
        case 13:
            ...
            D_800E9ED0 = 0;
            func_8005DC1C(Sfx_Unk1662, &QVECTOR3(62.3f, -1.45f, -61.07f), Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
        ...
        case 14:
            ...
            if (D_800E9ED4 < 0)
            {
                ...
                if (D_800E9ED4 > 0)
                {
                    func_8005DC1C(Sfx_Unk1651, &QVECTOR3(62.3f, 0.0f, -61.07f), Q8(0.5f), SfxFlag_None);
                }
            }
...
void func_800DD2D4(void) // 0x800DD2D4
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        case 0:
            Player_ControlFreeze();
            func_8005DC1C(Sfx_Unk1667, &QVECTOR3(21.1f, -1.5f, -60.75f), Q8(0.5f), SfxFlag_None);
        ...
        case 3:
            ...
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 144, false);
...
void func_800DD9E8(void) // 0x800DD9E8
{
    if (g_SysWork.sysStateSteps[0] >= 0 && g_SysWork.sysStateSteps[0] <= 6)
    {
        if (D_800E9EDA == 0)
        {
            func_8005DC1C(Sfx_Unk1666, &QVECTOR3(21.1f, -1.5f, -60.75f), Q8(0.5f), SfxFlag_None);
...
void func_800DDEC8(void) // 0x800DDEC8
{
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 4:
            func_8005DC1C(Sfx_Unk1494, &(VECTOR3){ Q12(180.5f), Q12(-0.5f), Q12(-60.6f) }, Q8(0.5f), SfxFlag_None);
            SD_Call(Sfx_Unk1495);
        ...
        case 10:
            ...
            func_8005DC1C(Sfx_Unk1497, &D_800E9D00, Q8(0.5f), SfxFlag_None);
...
void func_800DE1FC(void) // 0x800DE1FC
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 1:
            ...
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[0], 5, false);
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[2], 0, false);
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[3], 0, false);
...
void func_800DF21C(void) // 0x800DF21C
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 1:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[0], 6, false);
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[1], 25, false);
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 51, false);
        ...
        case 4:
            ...
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[1], 27, false);
            Model_AnimFlagsSet(&g_SysWork.playerWork.player.model, AnimFlag_Visible);
            SysWork_StateStepIncrement(0);
        ...
        case 7:
            ...
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[1], 12, false);
...
void func_800E0CB4(void) // 0x800E0CB4
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        case 0:
            ...
            Fs_QueueWaitForEmpty();
            Dms_HeaderFixOffsets((s_DmsHeader*)FS_BUFFER_11);
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 148, false);
            Event_SysStateStepIncrementAfterFade(0, false, 0, Q12(0.0f), false);
        ...
        case 1:
            ...
            if (*var_s0 == 0)
            {
                func_8005DC1C(Sfx_Unk1656, &SFX_POS_0, Q8(0.5f), SfxFlag_None);
                *var_s0 = Q12(1.2f);
            }
            else
            {
        ...
        case 3:
            func_8005DC1C(Sfx_Unk1655, &SFX_POS_1, Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
...
void func_800E1DAC(void) // 0x800E1DAC
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        case 0:
            ...
            func_8005DC1C(Sfx_Unk1654, &SFX_POS, Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
...
void func_800E1FF4(void) // 0x800E1FF4
{
    ...
    {
        func_8005DC1C(Sfx_Unk1464, &SFX_POS, Q8(0.5f), SfxFlag_None);
    }
...
void func_800E2DEC(void) // 0x800E2DEC
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 4:
            func_8005DC1C(Sfx_Unk1663, &QVECTOR3(60.0f, -1.2f, -96.0f), Q8(0.5f), SfxFlag_None);
        ...
        case 6:
            func_8005DC1C(Sfx_Unk1343, &QVECTOR3(60.0f, -1.2f, -96.0f), Q8(0.5f), SfxFlag_None);
            Player_ControlUnfreeze(false);
            SysWork_StateSetNext(SysState_Gameplay);
            break;

        case 7:
            func_8005DC1C(Sfx_DoorLocked, &QVECTOR3(60.0f, -1.2f, -96.0f), Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
    ...
    switch (CELL_XZ(projCellX0, projCellZ0))
    {
        ...
        case CELL_XZ(14, 12):
            ...
            if (Savegame_EventFlagGet(EventFlag_486) && !Savegame_EventFlagGet(EventFlag_549))
            {
                ...
                {
                    func_8005DC1C(Sfx_Unk1653, &D_800CDC4C, Q8(0.125f), SfxFlag_None);
        ...
        case CELL_XZ(12, 15):
            if (!Savegame_EventFlagGet(EventFlag_478) && g_SysWork.playerWork.player.position.vz < Q12(-19.0f))
            {
                ...
                func_8005DC1C(Sfx_Unk1528, &D_800CDC58, Q8_CLAMPED(1.0f), SfxFlag_NoDistAtten);
            }
            break;
    }

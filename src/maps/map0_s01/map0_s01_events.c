...
void Map_WorldObjectsInit(void) // 0x800DC9C8
{
    ...
    WorldObjectInit(&g_EventThing_KitchenKnife, 5.09f, -1.01f, 274.12f, 0.0f, 32.0f, 0.0f); 
    WorldObject_ModelNameSet(&g_EventThing_KitchenKnife.object_0, "KNIFE_HI");

    WorldObjectInit(&g_EventThing_Flashlight, 5.18f, -1.0f, 267.28f, -3.0f, 111.0f, 0.0f);
    WorldObject_ModelNameSet(&g_EventThing_Flashlight.object_0, "FLASH_HI");

    WorldObjectInit(&g_EventThing_Map, 5.24f, -1.0f, 267.21f, 0.0f, 57.0f, 0.0f);
    WorldObject_ModelNameSet(&g_EventThing_Map.object_0, "MAP_HIDE");

    WorldObjectInit(&g_EventThing_PocketRadio, 2.31f, -0.6f, 273.95f, 0.0f, 147.0f, 0.0f);

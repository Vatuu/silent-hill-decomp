...
void MapEvent_ToBeContinued(void) // 0x800DB790
{
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        case 8:
            ...
            func_8004690C(Sfx_RadioHeavyStaticLoop);
            func_8004690C(Sfx_RadioLightStaticLoop);
            SysWork_StateStepIncrement(0);
...
void MapEvent_AirScreamerIntroCutscene() // 0x800DBAA0
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        case 0:
            ...
            Sd_EngineCmd(Sfx_RadioHeavyStaticLoop);
            Sd_EngineCmd(Sfx_RadioLightStaticLoop);
...
void Map_WorldObjectsInit() // 0x800DC9C8
{
    ...
    WorldObjectPoseInit(&g_EventThing_KitchenKnife.position_1C, 5.09f, -1.01f, 274.12f, 0.0f, 32.0f, 0.0f); 
    WorldObject_ModelNameSet(&g_EventThing_KitchenKnife.object_0, "KNIFE_HI");

    WorldObjectPoseInit(&g_EventThing_Flashlight.position_1C, 5.18f, -1.0f, 267.28f, -3.0f, 111.0f, 0.0f);
    WorldObject_ModelNameSet(&g_EventThing_Flashlight.object_0, "FLASH_HI");

    WorldObjectPoseInit(&g_EventThing_Map.position_1C, 5.24f, -1.0f, 267.21f, 0.0f, 57.0f, 0.0f);
    WorldObject_ModelNameSet(&g_EventThing_Map.object_0, "MAP_HIDE");

    WorldObjectPoseInit(&g_EventThing_PocketRadio.position_1C, 2.31f, -0.6f, 273.95f, 0.0f, 147.0f, 0.0f);
...
void Map_WorldObjectsUpdate(void) // 0x800DCCF4
{
    ...
    if (Savegame_EventFlagGet(EventFlag_52))
    {
        ...
        func_8005DE0C(Sfx_RadioHeavyStaticLoop, &D_800DE154, D_800E23A1, 0x10000, 0);
        func_8005DE0C(Sfx_RadioLightStaticLoop, &D_800DE154, D_800E23A1, 0x10000, 0);

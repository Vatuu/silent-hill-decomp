...
void func_800D3A3C(s_SubCharacter* chara) // 0x800D3A3C
{
    ...
    Ai_AirScreamer_Update(chara, (&g_InitializedCharaAnimInfo[idx])->animFile1_8, (&g_InitializedCharaAnimInfo[idx])->npcCoords_14);
...
s32 func_800D4AEC(s_SubCharacter* arg0, VECTOR3* arg1, VECTOR3* arg2, VECTOR3* arg3) // 0x800D4AEC
{
    s32      sp18;
    VECTOR3* var_s0;
    s32      temp_v1;
    ...
    D_800DE1A0.vx = temp_s3;
    D_800DE1A0.vz = temp_s4;
    ...
    sp18 = func_8006DB3C(&sharedData_800E2330_0_s01, var_s0, &D_800DE1A0, arg0);

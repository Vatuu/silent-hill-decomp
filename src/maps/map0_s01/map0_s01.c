...
void func_800D3CC4(s_SubCharacter* chara)
{
    ...
    switch (chara->model_0.stateStep_3)
    {
        case 0:
            cond = true;
            chara->model_0.anim_4.status_0 = ANIM_STATUS_GET(23, true);
            chara->model_0.stateStep_3 = 1;
            break;

        case 2:
            cond = true;
            chara->model_0.anim_4.status_0 = ANIM_STATUS_GET(24, true);
        ...
        case 4:
            cond = true;
            chara->model_0.anim_4.status_0 = ANIM_STATUS_GET(15, true);
        ...
        case 6:
            if (chara->model_0.anim_4.status_0 == ANIM_STATUS_GET(19, true))
            {

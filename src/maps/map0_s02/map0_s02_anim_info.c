...
s_AnimInfo HARRY_M0S02_ANIM_INFOS[] = {
    ...
    { Anim_Update2, ANIM_STATUS(44, false), false, ANIM_STATUS(44, true), { Q12(10.0f) }, NO_VALUE, 485 },
    { Anim_Update0, ANIM_STATUS(44, true),  false, ANIM_STATUS(44, true), { Q12(20.0f) }, 485,      502 },
    {}
};

...
s_AnimInfo g_AnimInfos[] =
{
    ...
    { Anim_Update2, ANIM_STATUS(44, false), 0, ANIM_STATUS(44, true), 0, { FP_TIME(10.0f) }, NO_VALUE, 485 },
    { Anim_Update0, ANIM_STATUS(44, true),  0, ANIM_STATUS(44, true), 0, { FP_TIME(20.0f) }, 485,      502 },
    {} // End of list.
};

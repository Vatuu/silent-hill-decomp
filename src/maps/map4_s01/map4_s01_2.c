...
// TODO: Make functions decls in header.
...
void func_800D1FF0(void) // 0x800D1FF0
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        case 5:
            ...
            g_SysWork.player_4C.chara_0.rotation_24.vy = Q12(0.0f);
...
void func_800D2408(void) // 0x800D2408
{
    ...
    #define cybil  &g_SysWork.npcs_1A0[0]
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        case 4:
            func_8005DC1C(Sfx_Unk1309, &soundPos, 128, 0);
            SysWork_StateStepIncrement();
        ...
        case 6:
            func_80085EB8(0, player, 118, false);
            func_8005DC1C(Sfx_Unk1310, &soundPos, 128, 0);
            SysWork_StateStepIncrement();
        ...
        case 8:
            ...
            func_80085EB8(0, cybil, 5, false);
            func_8003D01C();
            SysWork_StateStepIncrement();

        case 9:
            func_80085EB8(1, player, 0, false);
        ...
        case 11:
            func_80086C58(player, 119);
            break;

        case 12:
            func_80085EB8(0, player, 51, false);
            func_80085EB8(0, cybil, 1, false);
            func_8003D03C();
        ...
        case 25:
            func_80085EB8(0, player, 72, false);
            func_80085EB8(0, cybil, 1, false);
            SysWork_StateStepIncrement();
        ...
        case 28:
            func_80085EB8(3, player, 0, false);
            func_80085EB8(0, player, 0x33, false);
            func_80085EB8(0, cybil, 5, false);
        ...
        case 29:
            Map_MessageWithAudio(61, &g_MapMsgSoundIdx, g_MapMsgSounds);
            break;

        case 30:
            func_80085EB8(0, player, 140, false);
        ...
        case 35:
            ...
            func_80085EB8(0u, player, 51, false);
            SysWork_StateStepIncrement();
        ...
        case 38:
            func_80085EB8(0, player, 0x82, false);
        ...
        {
            Dms_CharacterGetPosRot(player.position_18, player.rotation_24, &D_800CBF94, g_Timer0, (s_DmsHeader*)FS_BUFFER_11);

            if (D_800D5AEB)
            {
                Dms_CharacterGetPosRot(cybil.position_18, cybil.rotation_24, &D_800CBF9C, g_Timer0, (s_DmsHeader*)FS_BUFFER_11);
            }
...
void func_800D2F74(void) // 0x800D2F74
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        case 0:
            ...
            func_80085EB8(0, player, 0x79, false);
    ...
    {
        Dms_CharacterGetPosRot(player.position_18, player.rotation_24, &D_800CBF94, g_Timer1, (s_DmsHeader*)FS_BUFFER_11);
...
void func_800D4410(void) // 0x800D4410
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        case 0:
            ...
            func_80085EB8(0, player, 124, false);
        ...
        case 6:
            func_80085EB8(0, player, 0x99, false);
            SysWork_StateStepIncrement();
    ...
    {
        Dms_CharacterGetPosRot(player.position_18, player.rotation_24, &D_800CBF94, g_Timer2, (s_DmsHeader*)FS_BUFFER_11);
...
void func_800D49C4(void) // 0x800D49C4
{
    ...
    Math_Vector3Set(&WorldObject_D_800D8020.pose_1C.position_0, Q12(174.81f), Q12(-1.4197f), Q12(21.3344f));
    ...
    Math_Vector3Set(&WorldObject_D_800D80B0.pose_1C.position_0, Q12(181.22f), 0, Q12(61.2015f));
...
void func_800D4BA4(void) // 0x800D4BA4
{
    ...
    if (PLAYER_IN_MAP_CHUNK(vx, 1, 5, -1, 5) && PLAYER_IN_MAP_CHUNK(vz, 1, 2, -1, 2))
    {
        ...
        {
            g_WorldGfx_ObjectAdd(&WorldObject_D_800D80B0.object_0, &WorldObject_D_800D80B0.pose_1C.position_0, &(SVECTOR3){});
        }
    ...
    if (PLAYER_IN_MAP_CHUNK(vx, 1, 5, -1, 5) && PLAYER_IN_MAP_CHUNK(vz, 0, 0, -1, 1))
    {
        ...
        {
            g_WorldGfx_ObjectAdd(&WorldObject_D_800D8020.object_0, &WorldObject_D_800D8020.pose_1C.position_0, &(SVECTOR3){});
        }
    }

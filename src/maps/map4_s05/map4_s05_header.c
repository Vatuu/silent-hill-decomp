...
const s_MapOverlayHeader g_MapOverlayHeader =
{
  ...
  .field_16 = 2,
  .field_17 = 0,
  .loadingScreenFuncs_18 = 0x800D7B34,
  .mapPointsOfInterest_1C = MAP_POINTS,
  .mapEventFuncs_20 = 0x800D7C28,
  .mapEvents_24 = 0x800D7C8C,
  .field_28 = 0x800BAF80,
  .loadableItems_2C = 0x800D77CC,
  ...
  .charaGroupIds_248 = { 15, 0, 0, 0 },
  .charaSpawns_24C = {
    {
      {
        .positionX_0 = Q12(-121.5f),
        .data = {
          .spawnInfo = {

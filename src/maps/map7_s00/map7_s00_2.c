...
void func_800D0110(void)
{
    ...
    switch (g_GameWork.bgmIdx_5B2)
    {
        ...
        case 14:
        case 22:
            bgmLayerLimitPtr = &D_800D2F74;
            flags            = D_800D2F28[mapRoomIdx];

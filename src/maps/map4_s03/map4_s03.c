...
#include "maps/shared/Player_ControlFreeze.h" // 0x800CFEF0

#include "maps/shared/Player_ControlUnfreeze.h" // 0x800D0050

#include "maps/shared/sharedFunc_800D23EC_0_s00.h" // 0x800D0228
...
#include "maps/shared/sharedFunc_800D2E6C_0_s00.h" // 0x800D0420

#include "maps/shared/sharedFunc_800D2E74_0_s00.h" // 0x800D0428

#include "maps/shared/sharedFunc_800D2E7C_0_s00.h" // 0x800D0430

#include "maps/shared/sharedFunc_800D2E84_0_s00.h" // 0x800D0438

#include "maps/shared/sharedFunc_800D2E8C_0_s00.h" // 0x800D0440

#include "maps/shared/sharedFunc_800D2E94_0_s00.h" // 0x800D0448

#include "maps/shared/sharedFunc_800D2E9C_0_s00.h" // 0x800D0450
...
void func_800D6774(void) // 0x800D6774
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        case 0:
            ...
            {
                func_80085EB8(0, &g_SysWork.player_4C.chara_0, 129, false);
            }
            else
            {
                func_80085EB8(0, &g_SysWork.player_4C.chara_0, 128, false);
            }
        ...
        case 9:
            ...
            g_SysWork.player_4C.chara_0.position_18.vx += Q12(0.5f);
        ...
        case 13:
            ...
            g_SysWork.player_4C.chara_0.position_18.vz = Q12(141.5f);
            g_SysWork.player_4C.chara_0.rotation_24.vy = FP_ANGLE(-45.0f);
...
void func_800D6F24(void) // 0x800D6F24
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        case 3:
            g_SysWork.player_4C.chara_0.position_18.vx = Q12(124.4f);
            g_SysWork.player_4C.chara_0.position_18.vz = Q12(140.9f);
        ...
        case 8:
            g_SysWork.player_4C.chara_0.position_18.vx = Q12(126.86f);
            g_SysWork.player_4C.chara_0.position_18.vz = Q12(140.36f);

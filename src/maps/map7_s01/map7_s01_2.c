...
void func_800D8984(void) // 0x800D8984
{
    ...
    Map_MessageWithSfx(79, Sfx_Unk1645, &D_800CC528);
    func_8004EE94(117, 1);
...
void func_800D8A5C(void) // 0x800D8A5C
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        case 2:
            SysWork_StateStepIncrementAfterFade(1, true, 2, 0, false);
            break;
...
void func_800D9C9C(void)
{
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        case 9:
            ...
            D_800E2CA8 += (g_Controller0->sticks_24.sticks_0.leftX << 14) / 75;
            D_800E2CA8  = CLAMP_RANGE(D_800E2CA8, Q12(-80.0f), Q12(80.0f));

            D_800E2CAC += (g_Controller0->sticks_24.sticks_0.leftY << 14) / 75;

...
void func_800D725C(void) // 0x800D725C
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 17:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.npcs[0], 18, false);
...
void func_800D7A60(void) // 0x800D7A60
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 17:
            Event_SysStateStepIncrementAfterFade(2, true, false, Q12(0.0f), false);
            break;
...
void func_800D8A5C(void) // 0x800D8A5C
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        case 0:
            ...
            Event_SysStateStepIncrementAfterFade(false, true, 2, Q12(0.0f), false);
            sharedFunc_800D2EB4_0_s00();
            func_8003D03C();
            SysWork_StateStepIncrement(0);
        ...
        case 3:
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 145, false);
        ...
        case 4:
            for (i = 0; i < ARRAY_SIZE(D_800E1678); i++)
            {
                if (D_800E1678[i] > 0)
                {
                    ...
                    func_8005DC1C(Sfx_Unk1642, &D_800CC534, Q8(0.5f), SfxFlag_None);
                    break;
                }
            }
            break;
        ...
        case 5:
            func_8005DC1C(Sfx_Unk1643, &D_800CC540, Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
...
void func_800D8FF8(void) // 0x800D8FF8
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        case 0:
            ...
            func_8005DC1C(Sfx_Unk1660, &D_800E1504, Q8(0.5f), SfxFlag_None);
        ...
        case 4:
            ...
            {
                func_8005DC1C(Sfx_Unk1661, &D_800E1504, Q8(0.5f), SfxFlag_None);
        ...
        case 6:
            ...
            func_8005DC1C(Sfx_Unk1658, &D_800CC5AC, Q8(0.5f), SfxFlag_None);
            Event_CharaAnimCommandExecute(CharaAnimCommand_SetState, &g_SysWork.playerWork.player, 167, false);
            SysWork_StateStepIncrement(0);
        ...
        case 8:
            func_8005DC1C(Sfx_Unk1327, &D_800CC5B8, Q8(0.5f), SfxFlag_None);
            SysWork_StateStepIncrement(0);
...
void func_800D9C9C(void) // 0x800D9C9C
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 13:
            ...
            {
                case 0:
                    func_8005DC1C(Sfx_Unk1647, &g_WorldObject_Stone0.position, Q8(0.5f), SfxFlag_None);
                ...
                case 2:
                    ...
                    if (g_WorldObject_Stone0.position.vy < Q12(-1.05f))
                    {
                        ...
                        if (g_WorldObject_Stone0.position.vy > Q12(-1.05f))
                        {
                            ...
                            func_8005DC1C(Sfx_Unk1648, &g_WorldObject_Stone0.position, Q8(0.5f), SfxFlag_None);
                        }
                    }
                    break;
                ...
                case 5:
                    ...
                    func_8005DC1C(Sfx_Unk1649, &g_WorldObject_Stone0.position, Q8(0.5f), SfxFlag_None);
                    SysWork_StateStepIncrement(0);
                    break;
            }
            break;
    ...
    switch (CELL_XZ(projCellX0, projCellZ0))
    {
        ...
        case CELL_XZ(11, 15):
            if (!Savegame_EventFlagGet(EventFlag_M7S01_PickupKeyOfPhaleg))
            {
                ...
                {
                    func_8005DC1C(Sfx_Unk1646, &D_800CC984, Q8(0.5f), SfxFlag_None);
        ...
        case CELL_XZ(14, 12):
            ...
            if (Savegame_EventFlagGet(EventFlag_486) && !Savegame_EventFlagGet(EventFlag_549))
            {
                ...
                func_8005DC1C(Sfx_Unk1653, &D_800CC998, Q8(0.125f), SfxFlag_None);

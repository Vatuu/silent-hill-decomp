...
INCLUDE_ASM("asm/maps/map1_s03/nonmatchings/map1_s03", AI_Stalker_Update); // 0x800D2DC0
...
INCLUDE_ASM("asm/maps/map1_s03/nonmatchings/map1_s03", AI_Creaper_Update); // 0x800D8010

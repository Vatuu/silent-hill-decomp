...
void func_800E1D50(void) // 0x800E1D50
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 2:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(0.0f), Q12(19.0f), false, true);
            break;
    ...
    {
        Dms_CharacterTransformGet(&g_SysWork.playerWork.player.position, &g_SysWork.playerWork.player.rotation, D_800CC4C4, g_CutsceneTimer, (s_DmsHeader*)FS_BUFFER_14);
        vcChangeProjectionValue(Dms_CameraTargetGet(&g_CutsceneCameraPositionTarget, &g_CutsceneCameraLookAtTarget, NULL, g_CutsceneTimer, (s_DmsHeader*)FS_BUFFER_14));
        vcUserCamTarget(&g_CutsceneCameraPositionTarget, NULL, true);
        vcUserWatchTarget(&g_CutsceneCameraLookAtTarget, NULL, true);
        Dms_CharacterTransformGet(&g_SysWork.pointLightPosition, &lintRot, D_800CC4CC, g_CutsceneTimer, (s_DmsHeader*)FS_BUFFER_14);
        Dms_CharacterTransformGet(&lintPos, &lintRot, D_800CC4D4, g_CutsceneTimer, (s_DmsHeader*)FS_BUFFER_14);

        rotX = Q12_TO_Q6(lintPos.vx - g_SysWork.pointLightPosition.vx);
        rotZ = Q12_TO_Q6(lintPos.vz - g_SysWork.pointLightPosition.vz);

        g_SysWork.pointLightRotation.vx = -ratan2(lintPos.vy - g_SysWork.pointLightPosition.vy, Q6_TO_Q12(SquareRoot0(SQUARE(rotX) + SQUARE(rotZ))));
        g_SysWork.pointLightRotation.vy = ratan2(lintPos.vx - g_SysWork.pointLightPosition.vx, lintPos.vz - g_SysWork.pointLightPosition.vz);
...
void func_800E219C(void) // 0x800E219C
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 2:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(21.0f), Q12(68.0f), false, true);
            break;
        ...
        case 4:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(69.0f), Q12(80.0f), false, true);
            break;
        ...
        case 6:
            ...
            func_80085EB8(0, &playerChara, 167, false);
            func_80085EB8(0, &g_SysWork.npcs[0], 11, false);
            SysWork_StateStepIncrement(0);

        case 7:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(81.0f), Q12(95.0f), true, true);
            break;
    ...
    {
        // Get "HERO" position.
        Dms_CharacterTransformGet(&playerChara.position, &playerChara.rotation, D_800CC4C4, g_CutsceneTimer, FS_BUFFER_14);

        // Get "MSB" position
        Dms_CharacterTransformGet(&g_SysWork.npcs[0].position, &g_SysWork.npcs[0].rotation, D_800CC4DC, g_CutsceneTimer, FS_BUFFER_14);

        vcChangeProjectionValue(Dms_CameraTargetGet(&g_CutsceneCameraPositionTarget, &g_CutsceneCameraLookAtTarget, NULL, g_CutsceneTimer, FS_BUFFER_14));
        vcUserCamTarget(&g_CutsceneCameraPositionTarget, NULL, true);
        vcUserWatchTarget(&g_CutsceneCameraLookAtTarget, NULL, true);

        // "LIGHT", cutscene light position?
        Dms_CharacterTransformGet(&g_SysWork.pointLightPosition, &unused, D_800CC4CC, g_CutsceneTimer, FS_BUFFER_14);

        // "L_INT", interior light or intersection point?
        Dms_CharacterTransformGet(&lightIntPos, &unused, D_800CC4D4, g_CutsceneTimer, FS_BUFFER_14);
...
void func_800E2724(void) // 0x800E2724
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        case 0:
            ...
            Chara_Load(0, Chara_MonsterCybil, &g_SysWork.npcCoords[0], CHARA_FORCE_FREE_ALL, NULL, NULL);
            Chara_ProcessLoads();
...
void func_800E2950(void) // 0x800E2950
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        case 0:
            ...
            g_SysWork.pointLightPosition.vz = camPos.vz;

            func_80085EB8(0, &g_SysWork.npcs[0], 4, false);
        ...
        case 3:
            func_80085EB8(1, &g_SysWork.npcs[0], 0, false);
            break;
...
void MapEvent_CutsceneCybilDeath(void) // 0x800E2CA0
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 3:
            SD_Call(16);
            SD_Call(19);
            func_80085EB8(0, &playerChara, 162, false);
            func_80085EB8(0, &g_SysWork.npcs[0], 7, false);
            SysWork_StateStepIncrement(0);

        case 4:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(96.0f), Q12(131.0f), false, false);
        ...
        case 7:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(131.0f), Q12(195.0f), false, false);
...
void func_800E3244(void) // 0x800E3244
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 1:
            func_80085EB8(0, &playerChara, 170, false);
            func_80085EB8(0, &g_SysWork.npcs[0], 8, false);
            SysWork_StateStepIncrement(0);

        case 2:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(0.0f), Q12(24.0f), false, true);
            func_800E73B4(g_CutsceneTimer);
            break;
        ...
        case 4:
            func_80085EB8(0, &playerChara, 185, false);
            SysWork_StateStepIncrement(0);

        case 5:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(25.0f), Q12(58.0f), false, true);
            break;
        ...
        case 6:
            ...
            Chara_ProcessLoads();
            func_80085EB8(0, &playerChara, 160, false);
        ...
        case 7:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(59.0f), Q12(139.0f), false, true);
            func_800E7944(2);
            break;

        case 8:
            Chara_Spawn(Chara_Parasite, 0, Q12(20.0f), Q12(100.0f), 0, 3);
            func_8005DC1C(Sfx_Unk1625, &g_SysWork.npcs[1].position, 32, 0);
            func_8005DC1C(Sfx_Unk1624, &g_SysWork.npcs[1].position, 32, 0);
            func_800E7944(1);
            SysWork_StateStepIncrement(0);

        case 9:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(140.0f), Q12(183.0f), false, true);
        ...
        case 10:
            ...
            g_CutsceneTimer = Q12(186.0f);

            func_80085EB8(0, &playerChara, 163, false);
            func_800E7944(3);
            SysWork_StateStepIncrement(0);

        case 11:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(5.0f), Q12(186.0f), Q12(193.0f), false, true);
            func_8005DE0C(Sfx_Unk1624, &g_SysWork.npcs[1].position, 32, Q12(16.0f), 0);
            break;

        case 12:
            g_CutsceneTimer = Q12(195.0f);
        ...
        case 13:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(195.0f), Q12(213.0f), false, true);
            break;

        case 14:
            g_CutsceneTimer = Q12(216.0f);
        ...
        case 15:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(216.0f), Q12(243.0f), false, true);

            if (g_CutsceneTimer >= Q12(219.0f))
            {
        ...
        case 21:
            ...
            g_SysWork.pointLightIntensity = Q12(0.3594f);
            D_800ED5B8 = 1;
    ...
    if (g_SysWork.sysStateSteps[0] >= 22 && g_SysWork.sysStateSteps[0] <= 27)
    {
        ...
        Math_Vector3Set(&g_SysWork.pointLightPosition, FP_FROM(Math_Sin(D_800ED5B6 - Q12(0.2188f)) * Q12(4.8f), Q12_SHIFT) + Q12(20.0f),
                        Q12(-1.0f),
                        FP_FROM(Math_Cos(D_800ED5B6 - Q12(0.2188f)) * Q12(4.8f), Q12_SHIFT) + Q12(100.0f));
        Math_SetSVectorFast(&g_SysWork.pointLightRotation, Q12_ANGLE(-39.4f), (D_800ED5B6 + Q12_ANGLE(182.9f)), Q12_ANGLE(0.0f));
        func_800E74C4();
    }

    if (g_CutsceneTimer > Q12(0.0f))
    {
        Dms_CharacterTransformGet(&playerChara.position, &playerChara.rotation, D_800CC4C4, g_CutsceneTimer, (s_DmsHeader*)FS_BUFFER_14);
        Dms_CharacterTransformGet(&g_SysWork.npcs[0].position, &g_SysWork.npcs[0].rotation, D_800CC4DC, g_CutsceneTimer, (s_DmsHeader*)FS_BUFFER_14);
        Dms_CharacterTransformGet(&g_SysWork.npcs[1].position, &g_SysWork.npcs[1].rotation, "ICU", g_CutsceneTimer, (s_DmsHeader*)FS_BUFFER_14);
...
void func_800E3EF4(void) // 0x800E3EF4
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 6:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(1.0f), Q12(24.0f), false, true);
            break;

        case 7:
            Map_MessageWithAudio(47, &D_800ED5AC, &D_800EBA64);
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(1.0f), Q12(39.0f), false, true);
            break;

        case 8:
            func_80085EB8(0, &playerChara, 149, false);
        ...
        case 9:
            Map_MessageWithAudio(47, &D_800ED5AC, &D_800EBA64);
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(1.0f), Q12(59.0f), false, false);
            break;

        case 10:
            Chara_Load(1, Chara_Flauros, &g_SysWork.npcCoords[30], 0, NULL, NULL);
            D_800EBAA8 = false;
            SysWork_StateStepIncrement(0);

        case 11:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(1.0f), Q12(59.0f), false, true);
            break;
        ...
        case 13:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(1.0f), Q12(79.0f), true, true);
            break;

        case 14:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(80.0f), Q12(104.0f), true, true);
            g_SysWork.pointLightIntensity = Q12(2.0f);
            Savegame_EventFlagSet(EventFlag_452);
            break;

        case 15:
            func_80085EB8(0, &playerChara, 150, false);
            func_800DFC94(&g_CutsceneTimer);
        ...
        case 16:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(105.0f), Q12(114.0f), false, true);
            break;

        case 17:
            Map_MessageWithAudio(48, &D_800ED5AC, &D_800EBA64);
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(105.0f), Q12(162.0f), true, false);
            break;

        case 18:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(105.0f), Q12(162.0f), true, true);
            break;
        ...
        case 20:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(163.0f), Q12(199.0f), true, false);
            break;

        case 21:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(163.0f), Q12(199.0f), true, true);
            break;

        case 22:
            func_80085EB8(0, &playerChara, 188, false);
        ...
        case 23:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(200.0f), Q12(229.0f), true, false);
            break;

        case 24:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(200.0f), Q12(229.0f), true, true);
            break;
        ...
        case 25:
            ...
            func_800DED30();
            func_800DEF50(&g_SysWork.npcs[1].position, &g_SysWork.npcCoords[30], &g_CutsceneTimer);
        ...
        case 26:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(230.0f), Q12(299.0f), true, true);
            break;

        case 27:
            func_80085EB8(0, &g_SysWork.npcs[0], 3, false);
            SysWork_StateStepIncrement(0);

        case 28:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(300.0f), Q12(310.0f), true, true);
            break;
        ...
        case 30:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(311.0f), Q12(357.0f), false, true);
            break;
        ...
        case 32:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(311.0f), Q12(365.0f), false, true);
            break;
        ...
        case 36:
            func_80085EB8(1, &g_SysWork.npcs[0], 0, false);
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(311.0f), Q12(386.0f), true, false);
            break;
        ...
        case 38:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(387.0f), Q12(431.0f), true, false);
            break;
        ...
        case 40:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(432.0f), Q12(454.0f), true, true);
            break;
        ...
        case 42:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(455.0f), Q12(455.0f), true, false);
        ...
        case 43:
            if (!Sd_AudioStreamingCheck())
            {
                ...
                Chara_Load(1, Chara_Dahlia, &g_SysWork.npcCoords[30], 2, NULL, &sp30);
        ...
        case 46:
            func_80085EB8(0, &g_SysWork.npcs[1], 14, false);
            D_800EBB60 = true;
            SysWork_StateStepIncrement(0);

        case 47:
            Map_MessageWithAudio(54, &D_800ED5AC, &D_800EBA64);
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(0.0f), Q12(10.0f), false, true);
            break;
        ...
        case 49:
            Map_MessageWithAudio(54, &D_800ED5AC, &D_800EBA64);
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(0.0f), Q12(30.0f), true, false);
            break;
        ...
        case 54:
            func_80085EB8(0, &g_SysWork.npcs[1], 13, false);
            g_SysWork.pointLightIntensity = Q12(0.7f);
            SysWork_StateStepIncrement(0);

        case 55:
            Map_MessageWithAudio(71, &D_800ED5AC, &D_800EBA64);
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(32.0f), Q12(80.0f), false, true);
            break;
        ...
        case 57:
            Map_MessageWithAudio(71, &D_800ED5AC, &D_800EBA64);
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(32.0f), Q12(110.0f), true, false);
            break;

        case 58:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(32.0f), Q12(110.0f), true, true);
            break;

        case 59:
            func_80085EB8(0, &playerChara, 123, false);
            g_SysWork.pointLightIntensity = Q12(1.0f);
            SysWork_StateStepIncrement(0);

        case 60:
            Map_MessageWithAudio(74, &D_800ED5AC, &D_800EBA64);
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(111.0f), Q12(145.0f), true, false);
            break;
    ...
    if (g_CutsceneTimer >= Q12(0.0f))
    {
        ...
        Dms_CharacterTransformGet(&g_SysWork.npcs[0].position, &g_SysWork.npcs[0].rotation, "ARSIA", g_CutsceneTimer, FS_BUFFER_14);

        if (D_800EBB60)
        {
            Dms_CharacterTransformGet(&g_SysWork.npcs[1].position, &g_SysWork.npcs[1].rotation, "DARIA", g_CutsceneTimer, FS_BUFFER_14);
        }

        if (D_800EBB61 == 3)
        {
            Dms_CharacterTransformGet(&g_WorldObject_SFlauros.position_1C, &g_WorldObject_SFlauros.rotation_28, "SFLAU", g_CutsceneTimer, FS_BUFFER_14);
        }
        ...
        if (D_800EBB61 == 2)
        {
            Dms_CharacterTransformGet(&g_SysWork.npcs[1].position, &g_SysWork.npcs[1].rotation, "BFLAU", g_CutsceneTimer, FS_BUFFER_14);
        }
    }

    if (g_SysWork.sysStateSteps[0] >= 48)
    {
        func_800E0FAC(g_CutsceneTimer);
    }
...
void func_800E558C(void) // 0x800E558C
{
    ...
    switch (g_SysWork.sysStateSteps[0])
    {
        ...
        case 2:
            ...
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(10.0f), Q12(0.0f), Q12(22.0f), true, true);
            break;

        case 3:
            Chara_ProcessLoads();
            Chara_Spawn(Chara_Alessa, 0, playerChara.position.vx + Q12(1.0f), playerChara.position.vz, Q12_ANGLE(11.3f), 3);
            func_80085EB8(0, &playerChara, 70, false);
        ...
        case 4:
            SysWork_StateStepIncrementAfterTime(&g_CutsceneTimer, Q12(3.5f), Q12(23.0f), Q12(33.0f), true, true);
            break;
...
void func_800E7944(u32 arg0) // 0x800E7944
{
    ...
    if (arg0 != 3)
    {
        if (D_800EBB7C != 0)
        {
            ...
            Vw_CoordHierarchyMatrixCompute(&g_SysWork.npcCoords[0x1F], &ptr->field_0);
        }
        else
        {
            Math_SetSVectorFastSum(&ptr->field_20, 0, 0xFFD7, -21);
            Vw_CoordHierarchyMatrixCompute(&g_SysWork.npcCoords[1], &ptr->field_0);
        }

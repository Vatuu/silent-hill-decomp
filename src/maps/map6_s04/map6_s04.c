...
void func_800D87B0(s_SubCharacter* chara) // 0x800D87B0
{
    ...
    {
        g_SysWork.npcs_1A0[0].properties.player.moveDistance_126 = Q12(1.5f);
        Model_AnimStatusSet(&chara->model, 9, false);
    }

    if (chara->model.anim.keyframeIdx == D_800EA856)
    {
        g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[1].val16[0] = 1;
        chara->model.stateStep = 0;
        g_SysWork.npcs_1A0[0].properties.player.field_122 = 0;
    }
}
...
void func_800D8848(s_Model* model) // 0x800D8848
{
    ...
    {
        g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[1].val16[1] = 1;
        model->stateStep                                                  = 0;
    }
}
...
s32 func_800D8898(s_AnimInfo* animInfo) // 0x800D8898
{
    ...
    {
        if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC == 0)
        {
            return 0;
        }

        if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 == 1)
        {
...
void Ai_MonsterCybil_Init(s_SubCharacter* chara, s_Model* extraModel) // 0x800D89CC
{
    ...
    chara->field_E1_0 = 3;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[12].val16[1] = Q12_ANGLE(90.0f);
    ...
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[7].val16[0] = 10;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[5].val16[1] = 0;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[7].val16[1] = 0;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[2].val32    = 0;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[8].val32    = 0;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[9].val32    = 0;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[4].val32    = 0;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[11].val8[2] = 0;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[3].val32    = 0;
...
void func_800D8A90(s_SubCharacter* chara) // 0x800D8A90
{
    ...
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[11].val8[1] = 0;
    D_800ED543                                                                   = 0;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[7].val16[0]  = 10;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[5].val16[1]  = 0;
    g_SysWork.npcs_1A0[0].properties.dummy.properties_E8[7].val16[1]  = 0;
    g_SysWork.npcs_1A0[0].properties.player.field_F0                          = 0;
    g_SysWork.npcs_1A0[0].properties.player.runTimer_108                      = 0;
    g_SysWork.npcs_1A0[0].properties.npc.field_10C                            = 0;
    g_SysWork.npcs_1A0[0].properties.player.runTimer_F8                       = 0;
}
...
void func_800D8B14(s_SubCharacter* chara, s_Model* model) // 0x800D8B14
{
    ...
    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F8 != Q12(0.0f))
    {
        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F8 -= g_DeltaTime * 15;
    }

    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F8 = CLAMP(g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F8, Q12(0.0f), INT_MAX);
    ...
    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_E8 < 13)
    {
        if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_E8 > 2)
        {
            return;
        }
    }

    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE == 9 ||
        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE == 11)
    {
        chara->damage.amount_C = Q12(0.0f);
    }
    else
    {
        if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE != 12)
        {
        ...
        {
            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F8 += chara->damage.amount_C;
            ...
            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_122 = sp12;
            ...
            {
                if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F8 >= Q12(800.0f))
                {
                    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC != 12)
                    {
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 9;
                        chara->model.stateStep                                 = 0;
                    }
                }

                if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F8 >= Q12(800.0f) ||
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE == 12)
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 9;
                    model->stateStep                                         = 0;
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F8 = 0;
                }
            }

            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 = 0;
            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_10C = 0;
        }
    }
}
...
void func_800D8D7C(s_SubCharacter* chara, s_Model* model, GsCOORDINATE2* coords) // 0x800D8D7C
{
    ...
    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_120)
    {
        g_SysWork.npcs_1A0[0].properties.player.runTimer_108 += g_DeltaTime;
    }
    else
    {
        g_SysWork.npcs_1A0[0].properties.player.runTimer_108 = Q12(0.0f);
    }

    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106++;

    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_E8)
    {
        case 0:
        ...
        case 4:
            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A = Q12(0.25f);

            Model_AnimStatusKeyframeSet(chara->model, 4, true, MONSTER_CYBIL_ANIM_INFOS, 0);
            ...
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F4 = 1;
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_E8 = 1;
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 1;
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 1;
                chara->model.stateStep                                = 0;
                model->stateStep                                        = 0;
            }
            break;
        ...
        case 5:
            ...
            {
                model->stateStep = 0;
                Model_AnimStatusKeyframeSet(chara->model, 14, true, MONSTER_CYBIL_ANIM_INFOS, 0);
            }
        ...
        case 6:
            ...
            if (chara->model.anim.keyframeIdx == 343)
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_E8 = 12;
                chara->model.stateStep                                = 0;
                model->stateStep                                         = 0;
            }
            break;
        ...
        case 12:
            Model_AnimStatusKeyframeSet(chara->model, 21, true, MONSTER_CYBIL_ANIM_INFOS, 0);
        ...
        case 9:
            ...
            {
                model->stateStep = 0;
                Model_AnimStatusKeyframeSet(chara->model, 20, true, MONSTER_CYBIL_ANIM_INFOS, 0);
            }
        ...
        case 10:
            ...
            {
                model->stateStep = 0;
                Model_AnimStatusKeyframeSet(chara->model, 18, true, MONSTER_CYBIL_ANIM_INFOS, 0);
            }
        ...
        case 11:
            ...
            {
                model->stateStep = 0;
                Model_AnimStatusKeyframeSet(chara->model, 19, true, MONSTER_CYBIL_ANIM_INFOS, 0);
            }
        ...
        case 7:
            ...
            {
                model->stateStep = 0;
                Model_AnimStatusKeyframeSet(chara->model, 16, true, MONSTER_CYBIL_ANIM_INFOS, 0);
            }
        ...
        case 8:
            ...
            {
                model->stateStep = 0;
                Model_AnimStatusKeyframeSet(chara->model, 17, true, MONSTER_CYBIL_ANIM_INFOS, 0);
            }
    ...
    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_E8)
    {
        ...
        case 11:
            if (chara->model.anim.keyframeIdx == 38)
            {
                func_8006342C(EquippedWeaponId_Unk63, Q12_ANGLE(90.0f), chara->rotation.vy, g_SysWork.npcCoords_FC0);
            }
        ...
        case 5:
            if (chara->model.anim.keyframeIdx < 312)
            {
    ...
    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC == 1)
    {
        sharedFunc_800D908C_0_s00(3, chara, 5, 16, sfxId, pitch0);
    }

    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE)
    {
        case 2:
            if (ANIM_STATUS_IS_ACTIVE(model->anim.status) && model->anim.keyframeIdx >= 29 && !sharedData_800D16E4_2_s01)
            {
                func_8005DC1C(Sfx_Unk1620, &chara->position, Q8(0.25f), 0);
        ...
        case 3:
            ...
            {
                func_8005DC1C(Sfx_Unk1622, &chara->position, Q8(0.25f), 0);
                sharedData_800D16E4_2_s01 = 1;
            }
    ...
    moveSpeed              = g_SysWork.npcs_1A0[0].properties.monsterCybil.field_126;
    angle0                 = g_SysWork.npcs_1A0[0].properties.monsterCybil.field_122;
    chara->headingAngle = Q12_ANGLE_ABS(angle0 + chara->rotation.vy);
...
void func_800D9790(s_SubCharacter* chara, s_Model* model) // 0x800D9790
{
    ...
    temp_s4 = chara->headingAngle;
    temp_s0 = Q12_MULT_PRECISE(chara->moveSpeed, g_DeltaTime);
    ...
    sp40.vy = Q12_MULT_PRECISE(chara->fallSpeed, g_DeltaTime);

    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC)
    {
        case 11:
...
void func_800D9AB4(s_SubCharacter* chara, s_Model* model, GsCOORDINATE2* coords) // 0x800D9AB4
{
    ...
    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC)
    {
        ...
        case 1:
            ...
            if (g_SysWork.playerWork.player.health > 0 && g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 == 0)
            {
                ...
                if (chara->model.anim.status == 3)
                {
                    if ((u16)chara->model.anim.keyframeIdx < 24)
                    {
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_126 = D_800CB208[chara->model.anim.keyframeIdx];
                    }
                }

                if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_120 == 0)
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_126 <<= 1;

                    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106 > 60)
                    {
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106 = 0;

                        if ((Rng_Rand16() % 10) > 4 && g_SysWork.npcs_1A0[0].properties.monsterCybil.field_110 > Q12(4.0f))
                        {
                            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_FE = func_800DB930();

                            if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_FE != NO_VALUE)
                            {
                                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 12;
                                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 12;
                                chara->model.stateStep                                 = 0;
                                model->stateStep                                         = 0;
                            }
                ...
                if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_104 <= 0 || chara->health < Q12(2000.0f))
                {
                    Savegame_EventFlagSet(EventFlag_444);

                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_E8 = 3;
                    chara->model.stateStep                                 = 0;
                    model->stateStep                                         = 0;
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F4 = 0;
                    return;
                }
            }
            else if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 == 1)
            {
                func_800DBE5C(chara);
            ...
            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_122 = 0;
            break;

        case 2:
            if (chara->model.stateStep == 0)
            {
                chara->model.anim.status = 4;
                chara->model.stateStep++;
            }
        ...
        case 8:
            ...
            if (chara->model.stateStep == 0)
            {
                chara->model.anim.status = 16;
                chara->model.stateStep++;
            }

            if (chara->model.anim.keyframeIdx == D_800EA836)
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 1;
                chara->model.stateStep                                 = 0;
            }
        ...
        case 11:
            if (chara->model.stateStep == 0)
            {
                chara->model.anim.status = 23;
                chara->model.stateStep++;
                chara->model.anim.time        = FP_TO(MONSTER_CYBIL_ANIM_INFOS[23].endKeyframeIdx, Q12_SHIFT);
                chara->model.anim.keyframeIdx = MONSTER_CYBIL_ANIM_INFOS[23].endKeyframeIdx;
            }

            if (chara->properties.monsterCybil.field_126 != 0)
            {
                chara->properties.monsterCybil.field_126 = chara->properties.monsterCybil.field_126 - 327;
                if (chara->properties.monsterCybil.field_126 < 0)
                {
                    chara->properties.monsterCybil.field_126 = 0;
                }
            }

            if (chara->model.anim.keyframeIdx == (D_800EA896 - 4) || chara->model.anim.keyframeIdx == (D_800EA896 - 5))
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_126 = Q12(0.6f);
            }

            if (chara->model.anim.keyframeIdx <= (D_800EA896 - 7))
            {
                chara->position.vy += g_GravitySpeed >> 2;
            }
            else if ((D_800EA896 - 4) >= chara->model.anim.keyframeIdx)
            {
                chara->position.vy += g_GravitySpeed >> 4;
            }
            else
            {
                chara->position.vy = g_SysWork.npcs_1A0[0].properties.monsterCybil.field_100 - 1843;
            }

            if (chara->position.vy > Q12(0.0f))
            {
                chara->position.vy = Q12(0.0f);
            }

            chara->rotation.vy = (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_FE < 6) ? (D_800CB2A0[g_SysWork.npcs_1A0[0].properties.monsterCybil.field_FE] - Q12_ANGLE(180.0f)) :
                                                                                                      D_800CB2A0[g_SysWork.npcs_1A0[0].properties.monsterCybil.field_FE];

            temp_v0 = 1;

            if (chara->model.anim.keyframeIdx == D_800EA894)
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = temp_v0;
                chara->model.stateStep                                 = 0;
            }
            break;

        case 12:
            chara->position.vx = D_800CB2B4[g_SysWork.npcs_1A0[0].properties.monsterCybil.field_FE] + Q12(20.0f);
            chara->position.vy = g_SysWork.npcs_1A0[0].properties.monsterCybil.field_100 - Q12(0.45f);
            chara->position.vz = D_800CB2DC[g_SysWork.npcs_1A0[0].properties.monsterCybil.field_FE] + Q12(100.0f);
            ...
            if (chara->model.stateStep == 0)
            {
                chara->model.anim.status = ANIM_STATUS(12, false);
                chara->model.stateStep++;
            }
    ...
    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE)
    {
        ...
        case 1:
            ...
            {
                model->anim.time        = chara->model.anim.time;
            ...
            if (g_SysWork.playerWork.player.health > 0 && g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 == 0)
            {
                    ...
                    (g_SysWork.playerWork.extra.state > 50 || g_SysWork.playerWork.extra.state < 47))
                {
                    ...
                    {
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 8;
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 8;
                        chara->model.stateStep                                 = 0;
                        model->stateStep                                         = 0;
                    }
                }
                          ...
                          g_SysWork.playerWork.extra.state == 48))
                {
                    ...
                    {
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 2;
                        chara->model.stateStep                                 = 0;
                    }

                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 2;
                    model->stateStep                                         = 0;
                }
            }
            break;
        ...
        case 2:
            if (model->stateStep == 0)
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F0 = 0;
            ...
            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F0 += g_DeltaTime;
            ...
            if (model->anim.keyframeIdx == D_800EA776 && D_800EBB48 < g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F0)
            {
                    ...
                    !(g_SysWork.playerWork.player.flags & (1 << 3)))
                {
                    ...
                    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC == 2)
                    {
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 3;
                        chara->model.stateStep                                 = 0;
                    }
                }
                else
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 10;
                    model->stateStep                                         = 0;

                    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC != 1)
                    {
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 10;
                        chara->model.stateStep                                 = 0;
                    }
                }
            }
        ...
        case 3:
            ...
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F0  = 0;
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_108 = 0;
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_104--;
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_114++;
            ...
            if (model->anim.keyframeIdx >= (MONSTER_CYBIL_ANIM_INFOS[7].startKeyframeIdx + 2) &&
                ...
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_115 == 0)
            {
                chara->model.anim.baseAnimInfos = MONSTER_CYBIL_ANIM_INFOS;
                chara->field_44.field_0          = 1;

                // TODO: What's weapon attack 63?
                func_8006342C(EquippedWeaponId_Unk63, g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A, chara->rotation.vy, g_SysWork.npcCoords_FC0);
                ...
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_115 = 1;
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 = 1;
                }
            }
            else
            {
            ...
            if (ANIM_STATUS_IS_ACTIVE(chara->model.anim.status) && model->anim.keyframeIdx == MONSTER_CYBIL_ANIM_INFOS[7].endKeyframeIdx)
            {
                if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_120 == 0 || g_SysWork.npcs_1A0[0].properties.monsterCybil.field_104 == 0 ||
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_114 == 3 || g_SysWork.npcs_1A0[0].properties.monsterCybil.field_115 != 0 ||
                ...
                else if ((D_800EBB4A + Q12(1.5f)) < g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F0)
                {
                    model->stateStep                                         = 0;
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F0 = 0;

                    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC == 3)
                    {
                        chara->model.stateStep = 0;
                    }
                }
        ...
        case 8:
            ...
            if (func_8008A0E4(chara->field_44.field_0, WEAPON_ATTACK(EquippedWeaponId_HandgunBullets, AttackInputType_Tap), chara, &D_800ED570, &g_SysWork.playerWork.player, chara->rotation.vy, 0x400) != -1)
            {
                ...
                {
                    func_8005DC1C(Sfx_Unk1630, &chara->position, Q8(0.25f), 0);
                }
        ...
        case 9:
            ...
            if (model->anim.keyframeIdx == D_800EA856 && g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC == 12)
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 11;
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 11;
                chara->model.stateStep                                 = 0;
                model->stateStep                                         = 0;
                chara->field_D8.offsetZ_2                                  = Q12(0.0f);
        ...
        case 10:
            ...
            if (model->anim.keyframeIdx == MONSTER_CYBIL_ANIM_INFOS[model->anim.status].startKeyframeIdx)
            {
                ...
                if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC == 10)
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 1;
                    chara->model.stateStep                                 = 0;
                }
        ...
        case 12:
            ...
            if (chara->model.stateStep == 0)
            {
                func_8005DC1C(Sfx_Unk1618, &chara->position, Q8(0.25f), 0);
            }
            ...
            if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_F0 >= Q12(10.0f) ||
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_108 >= Q12(6.0f))
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 11;
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 11;
                chara->model.stateStep                                 = 0;
...
void func_800DA9C8(s_SubCharacter* chara, s_Model* model, GsCOORDINATE2* coords) // 0x800DA9C8
{
    ...
    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC)
    {
        ...
        case 1:
            if (chara->model.stateStep == 0)
            {
                chara->model.anim.status = 3;
                chara->model.stateStep++;
                chara->model.anim.time        = MONSTER_CYBIL_ANIM_INFOS[3].startKeyframeIdx + Q12(3.0f);
                chara->model.anim.keyframeIdx = MONSTER_CYBIL_ANIM_INFOS[3].startKeyframeIdx + 3;
            }
                ...
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 == 0)
            {
                ...
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_10C += g_DeltaTime;
                }
                else
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_10C = 0;
                ...
                if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_10C > Q12(3.0f))
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 = 1;
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_10C = 0;
                }
        ...
        case 5:
            if (chara->model.stateStep == 0)
            {
                chara->model.anim.status = ANIM_STATUS(5, false);
                chara->model.stateStep++;
            }

            func_800DB748(chara);

            if (chara->model.anim.keyframeIdx >= (D_800EA7D4 + 10))
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_126 = Q12(0.7f);
            }
            break;
        ...
        case 6:
            ...
            if (chara->model.stateStep == 0)
            {
                chara->model.anim.status = ANIM_STATUS(6, false);
                chara->model.stateStep++;
            }
                ...
                g_SysWork.playerWork.extra.state < 34)
            {
                ...
                {
                    chara->position.vx -= Q12(1.0f / 128.0f);
                }
                else if (chara->position.vx < var_s3)
                {
                    chara->position.vx += Q12(1.0f / 128.0f);
                }

                if (var_a1 < chara->position.vz)
                {
                    chara->position.vz = chara->position.vz - Q12(1.0f / 128.0f);
                }
                else if (chara->position.vz < var_a1)
                {
                    chara->position.vz = chara->position.vz + Q12(1.0f / 128.0f);
                }
            }
        ...
        case 7:
            if (chara->model.stateStep == 0)
            {
                chara->model.anim.status = ANIM_STATUS(7, false);
                chara->model.stateStep++;
            }

            if (chara->model.anim.keyframeIdx == D_800EA816)
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 1;
                chara->model.stateStep                                 = 0;
                chara->position.vx                                     += Q12_MULT(Math_Sin(chara->rotation.vy + Q12_ANGLE(33.75f)), Q12(0.1f));
                chara->position.vz                                     += Q12_MULT(Math_Cos(chara->rotation.vy + Q12_ANGLE(33.75f)), Q12(0.1f));
            }
            break;
        ...
        case 8:
            ...
            if (chara->model.stateStep == 0)
            {
                chara->model.anim.status = ANIM_STATUS(8, false);
                chara->model.stateStep++;
            }
            break;
    ...
    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE)
    {
        ...
        case 1:
                ...
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106 > 30)
            {
                ...
                else
                {
                    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE == 1)
                    {
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 5;
                        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 5;
                        chara->model.stateStep                                 = 0;
                        model->stateStep                                         = 0;
                    }
                }
        ...
        case 5:
            ...
            if (model->anim.keyframeIdx == D_800EA7D6)
            {
                if (temp_v0_2 !=NO_VALUE)
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE = 6;
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC = 6;
                }
                else
                {
        ...
        case 6:
            ...
            if (ANIM_STATUS_IS_ACTIVE(model->anim.status))
            {
                ...
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_118 = 0;
                }
                else
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_118 = D_800CB238[model->anim.keyframeIdx - 91] +
...
void func_800DB4CC(s_SubCharacter* chara, s_Model* model, GsCOORDINATE2* coord) // 0x800DB4CC
{
    ...
    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EE)
    {
        ...
        case 11:
            ...
            if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_EC == 11 &&
        ...
        case 10:
            range = delta >> 1;
            if (range >= (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A - Q12_ANGLE(90.0f)))
            {
                if ((g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A - Q12_ANGLE(90.0f)) >= -range)
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A = Q12_ANGLE(90.0f);
                }
                else
                {
                    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A += range;
                }
            }
            else
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A -= delta;
            }

            Math_RotMatrixZ(g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A - Q12_ANGLE(90.0f), &coord[8].coord);
            break;
        ...
        case 3:
            ...
            if ((angle + delta) < g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A)
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A -= delta;
            }
            else
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A = angle;
            }
        ...
        case 6:
            func_80044F14(&coord[1], 0, 0, -g_SysWork.npcs_1A0[0].properties.player.field_118);
            break;
    }
}
...
void func_800DB748(s_SubCharacter* chara) // 0x800DB748
{
    ...
    {
        chara->rotation.vy = angleToPlayer;
    }
    else if (shortestAngle > Q12_ANGLE(0.0f))
    {
        chara->rotation.vy += Q12_ANGLE(11.3f);
    }
    else
    {
        chara->rotation.vy -= Q12_ANGLE(11.3f);
...
bool func_800DB81C(s_SubCharacter* chara) // 0x800DB81C
{
    ...
    dir.vy = Q12_MULT(D_800AD4C8[63].field_0, Math_Cos(g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A));
    dir.vx = Q12_MULT(Q12_MULT(D_800AD4C8[63].field_0, Math_Sin(g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A)), Math_Sin(chara->rotation.vy));
    dir.vz = Q12_MULT(Q12_MULT(D_800AD4C8[63].field_0, Math_Sin(g_SysWork.npcs_1A0[0].properties.monsterCybil.field_11A)), Math_Cos(chara->rotation.vy));
...
s32 func_800DBA48(s_SubCharacter* chara) // 0x800DBA48
{
    ...
    foundIdx = -1;
    distMax   = g_SysWork.npcs_1A0[0].properties.monsterCybil.field_110;
    count = (3 - var_s0) * 4;
    ...
    if (dist < distMax)
    {
        ...
        chara->position.vx = sp10.vx;
        chara->position.vz = sp10.vz;
        func_800DB748(chara);
        return 1;
    }
...
s32 func_800DBD64(s_SubCharacter* chara) // 0x800DBD64
{
    ...
    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_110 > Q12(2.0f))
    {
        return 0;
    }
    ...
    for (i = 0; i < 10; i++)
    {
        posX = chara->position.vx - Q12(20.0f);
        posZ = chara->position.vz - Q12(100.0f);
    ...
    return shortestDist < g_SysWork.npcs_1A0[0].properties.monsterCybil.field_110;
}
...
void func_800DBE5C(s_SubCharacter* chara)
{
    ...
    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_E8 == 1)
    {
    ...
    // TODO: Use macro.
    unkAngle0 = Q12_ANGLE_NORM_U(unkAngle1 + ratan2((chara->position.vx - Q12(20.0f)) >> 4, (chara->position.vz - Q12(100.0f)) >> 4) + Q12(1.0f));

    if (chara->model.anim.status == ANIM_STATUS(1, true))
    {
        if (chara->model.anim.keyframeIdx >= 0 &&
            chara->model.anim.keyframeIdx <= 23)
        {
            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_126 = D_800CB1D8[chara->model.anim.keyframeIdx];
        }
    }

    Math_ShortestAngleGet(chara->rotation.vy, unkAngle0, &angle);
    if (ABS(angle) < Q12_ANGLE(5.625f))
    {
        chara->rotation.vy = unkAngle0;
    }
    else if (angle > Q12_ANGLE(0.0f))
    {
        chara->rotation.vy += Q12_ANGLE(5.625f);
    }
    else
    {
        chara->rotation.vy -= Q12_ANGLE(5.625f);
    ...
    chara->rotation.vy += (Rng_Rand16() % Q12_ANGLE(11.25f)) - Q12_ANGLE(5.625f);

    g_SysWork.npcs_1A0[0].properties.monsterCybil.field_10C += g_DeltaTime;
    if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_10C > Q12(5.0f))
    {
        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 = 0;
        g_SysWork.npcs_1A0[0].properties.monsterCybil.field_10C = 0;
    }
...
void func_800DC018(s_SubCharacter* chara) // 0x800DC018
{
    ...
    switch (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116)
    {
        case 2:
            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106 += TIMESTEP_SCALE_30_FPS(g_DeltaTime, Q12_ANGLE(11.25f / 4.0f));
            g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106 = CLAMP(g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106,
                                                                               Q12_ANGLE(0.0f),
                                                                               Q12_ANGLE(135.0f));

            newRotY = chara->rotation.vy;
            if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106 < Q12_ANGLE(90.0f))
            {
                newRotY += TIMESTEP_SCALE_30_FPS(g_DeltaTime, Q12_ANGLE(11.25f / 4.0f));
            }
            chara->rotation.vy = newRotY;

            if (g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106 == Q12_ANGLE(135.0f))
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106 = Q12_ANGLE(0.0f);
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 = 0;
            }
            break;
        ...
        default:
            from.vx = chara->position.vx;
            from.vy = chara->position.vy;
            from.vz = chara->position.vz;

            to.vx = chara->position.vx + Q12_MULT(Math_Sin(chara->rotation.vy), Q12(0.3f));
            to.vy = from.vy;
            to.vz = chara->position.vz + Q12_MULT(Math_Cos(chara->rotation.vy), Q12(0.3f));

            if (Ray_LineCheck(&ray, &from, &to))
            {
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_116 = (Rng_Rand16() & 0x1) + 2;
                g_SysWork.npcs_1A0[0].properties.monsterCybil.field_106 = Q12_ANGLE(0.0f);
            }
            break;
    }

...
INCLUDE_ASM("asm/maps/map7_s03/nonmatchings/map7_s03", Ai_Cybil_Update); // 0x800D1098
...
INCLUDE_ASM("asm/maps/map7_s03/nonmatchings/map7_s03", Ai_BloodyLisa_Update); // 0x800D4C50

...
#include "maps/shared/Ai_AirScreamerControl_2.h" // 0x800D2808

#include "maps/shared/Ai_AirScreamerControl_3.h" // 0x800D2A28

#include "maps/shared/Ai_AirScreamerControl_4.h" // 0x800D2B88

#include "maps/shared/Ai_AirScreamerControl_5.h" // 0x800D2F3C

#include "maps/shared/Ai_AirScreamerControl_6.h" // 0x800D32AC

#include "maps/shared/Ai_AirScreamerControl_7.h" // 0x800D3680

#include "maps/shared/Ai_AirScreamerControl_8.h" // 0x800D3A5C

#include "maps/shared/Ai_AirScreamerControl_9.h" // 0x800D3E4C

#include "maps/shared/Ai_AirScreamerControl_10.h" // 0x800D4138

#include "maps/shared/Ai_AirScreamerControl_11.h" // 0x800D4558

#include "maps/shared/Ai_AirScreamerControl_12.h" // 0x800D476C

#include "maps/shared/Ai_AirScreamerControl_13.h" // 0x800D4990

#include "maps/shared/Ai_AirScreamerControl_14.h" // 0x800D4C20

#include "maps/shared/Ai_AirScreamerControl_15.h" // 0x800D4FE4

#include "maps/shared/Ai_AirScreamerControl_16.h" // 0x800D50E8

#include "maps/shared/Ai_AirScreamerControl_17.h" // 0x800D5584

#include "maps/shared/Ai_AirScreamerControl_18.h" // 0x800D5660

#include "maps/shared/Ai_AirScreamerControl_19.h" // 0x800D5A0C

#include "maps/shared/Ai_AirScreamerControl_20.h" // 0x800D5D88

#include "maps/shared/Ai_AirScreamerControl_21.h" // 0x800D6150

#include "maps/shared/Ai_AirScreamerControl_22.h" // 0x800D6530

#include "maps/shared/Ai_AirScreamerControl_23.h" // 0x800D68F0

#include "maps/shared/Ai_AirScreamerControl_24.h" // 0x800D6CD0

#include "maps/shared/Ai_AirScreamerControl_25.h" // 0x800D6FDC

#include "maps/shared/Ai_AirScreamerControl_26.h" // 0x800D71FC

#include "maps/shared/Ai_AirScreamerControl_27.h" // 0x800D746C

#include "maps/shared/Ai_AirScreamerControl_28.h" // 0x800D7818

#include "maps/shared/Ai_AirScreamerControl_29.h" // 0x800D7928

#include "maps/shared/Ai_AirScreamerControl_30.h" // 0x800D7D84

#include "maps/shared/Ai_AirScreamerControl_31.h" // 0x800D7E98

#include "maps/shared/Ai_AirScreamerControl_32.h" // 0x800D7FCC

#include "maps/shared/Ai_AirScreamerControl_33.h" // 0x800D80D0

#include "maps/shared/Ai_AirScreamerControl_34.h" // 0x800D84C0

#include "maps/shared/Ai_AirScreamerControl_35.h" // 0x800D8844

#include "maps/shared/Ai_AirScreamerControl_36.h" // 0x800D8CB8

#include "maps/shared/Ai_AirScreamerControl_37.h" // 0x800D917C

#include "maps/shared/Ai_AirScreamerControl_38.h" // 0x800D94E4

#include "maps/shared/Ai_AirScreamerControl_39.h" // 0x800D988C

#include "maps/shared/Ai_AirScreamerControl_40.h" // 0x800D9C1C

#include "maps/shared/Ai_AirScreamerControl_41.h" // 0x800D9E04

#include "maps/shared/Ai_AirScreamerControl_42.h" // 0x800DA130

#include "maps/shared/Ai_AirScreamerControl_43.h" // 0x800DA490

#include "maps/shared/Ai_AirScreamerControl_44.h" // 0x800DA59C

#include "maps/shared/Ai_AirScreamerControl_45.h" // 0x800DA9D0
...
#include "maps/shared/sharedFunc_800D4E84_0_s01.h" // 0x800DB908

#include "maps/shared/sharedFunc_800D5274_0_s01.h" // 0x800DBCF8

#include "maps/shared/sharedFunc_800DD13C_2_s00.h" // 0x800DBD20

#include "maps/shared/sharedFunc_800DD2C4_2_s00.h" // 0x800DBEA8
...
#include "maps/shared/sharedFunc_800DDA80_2_s00.h" // 0x800DC664
...
#include "maps/shared/sharedFunc_800DE250_2_s00.h" // 0x800DCE34
...
#include "maps/shared/sharedFunc_800D53AC_0_s01.h" // 0x800DD524
...
#include "maps/shared/sharedFunc_800DEE24_2_s00.h" // 0x800DDA08
...
#include "maps/shared/sharedFunc_800DF2D0_2_s00.h" // 0x800DDEB4

#include "maps/shared/sharedFunc_800DF358_2_s00.h" // 0x800DDF3C

#include "maps/shared/sharedFunc_800DF448_2_s00.h" // 0x800DE02C

#include "maps/shared/sharedFunc_800DF60C_2_s00.h" // 0x800DE1F0

#include "maps/shared/sharedFunc_800DF710_2_s00.h" // 0x800DE2F4

#include "maps/shared/sharedFunc_800DF80C_2_s00.h" // 0x800DE3F0

#include "maps/shared/sharedFunc_800DF8A0_2_s00.h" // 0x800DE484
...
#include "maps/shared/sharedFunc_800E012C_2_s00.h" // 0x800DED10

#include "maps/shared/sharedFunc_800E021C_2_s00.h" // 0x800DEE00

#include "maps/shared/sharedFunc_800E041C_2_s00.h" // 0x800DF000

#include "maps/shared/sharedFunc_800E04B0_2_s00.h" // 0x800DF094

#include "maps/shared/sharedFunc_800E0514_2_s00.h" // 0x800DF0F8

#include "maps/shared/sharedFunc_800D5E78_0_s01.h" // 0x800DF1F4

#include "maps/shared/sharedFunc_800D5F00_0_s01.h" // 0x800DF27C
...
#include "maps/shared/sharedFunc_800D6600_0_s01.h" // 0x800DF97C
...
#include "maps/shared/sharedFunc_800D7120_0_s01.h" // 0x800E049C
...
#include "maps/shared/sharedFunc_800D77D0_0_s01.h" // 0x800E0B4C

#include "maps/shared/sharedFunc_800D7AB0_0_s01.h" // 0x800E0E2C

#include "maps/shared/sharedFunc_800D7B14_0_s01.h" // 0x800E0E90

#include "maps/shared/sharedFunc_800D7EBC_0_s01.h" // 0x800E1204

#include "maps/shared/sharedFunc_800D81B0_0_s01.h" // 0x800E14F8

#include "maps/shared/sharedFunc_800D81D0_0_s01.h" // 0x800E1518

#include "maps/shared/sharedFunc_800D8244_0_s01.h" // 0x800E158C

#include "maps/shared/sharedFunc_800D82B8_0_s01.h" // 0x800E1600
...
INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", sharedFunc_800E384C_2_s00); // 0x800E22C8
...
#include "maps/shared/sharedFunc_800E66E8_2_s02.h" // 0x800E6AE4

#include "maps/shared/sharedFunc_800E6758_2_s02.h" // 0x800E6B54

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", func_800E6C74);

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", func_800E703C);

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", func_800E793C);

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", func_800E7DD4);

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", func_800E8438);
...
INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", sharedFunc_800E8A40_2_s02); // 0x800E8E3C

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", sharedFunc_800E8DFC_2_s02); // 0x800E91F8

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", func_800E9798);

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", func_800E98B0);

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", func_800E9B10);

#include "maps/shared/sharedFunc_800D929C_0_s00.h" // 0x800E9D28

#include "maps/shared/Map_RoomIdxGet.h" // 0x800E9D38

INCLUDE_ASM("maps/map4_s02/nonmatchings/map4_s02", func_800E9F34);

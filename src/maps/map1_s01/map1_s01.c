...
void func_800D7864(void) // 0x800D7864
{
    ...
    #define NO_PIANO_STATE_CHECK 21
        ...
        g_SysWork.sysStateStep_C[0] >= START_PIANO_STATE && g_SysWork.sysStateStep_C[0] < END_PIANO_STATE)
    {
        ...
        g_WorldObject0.pose_1C.rotation_C.vx = FP_ANGLE(-90.0f);
        g_WorldObject0.pose_1C.position_0.vx = Q12(-98.8f);
        g_WorldObject0.pose_1C.position_0.vy = Q12(0.0f);
        g_WorldObject0.pose_1C.position_0.vz = Q12(22.8f);
        g_WorldObject0.pose_1C.rotation_C.vy = FP_ANGLE(28.5f);
    }
    ...
    switch (g_SysWork.sysStateStep_C[0])
    {
        ...
        case 4:
            func_800862F8(2, 0, false);
            MapMsg_DisplayAndHandleSelection(true, 29, CHECK_PIANO_STATE, NO_PIANO_STATE_CHECK, 0, false); // "Check the piano?"
            break;
        ...
        case 12:
            ...
            g_WorldObject0.pose_1C.rotation_C.vx += FP_MULTIPLY_PRECISE(g_DeltaTime0, Q12(0.0555f), Q12_SHIFT);
            g_WorldObject0.pose_1C.position_0.vy = FP_FROM((Math_Cos(g_WorldObject0.pose_1C.rotation_C.vx) * FP_ANGLE(-43.2f)), Q12_SHIFT) - Q12(2.5601f);
            g_WorldObject0.pose_1C.position_0.vz = FP_FROM((Math_Sin(g_WorldObject0.pose_1C.rotation_C.vx) * FP_ANGLE(-43.2f)), Q12_SHIFT) + Q12(23.73f);
            break;

        case 13:
            D_800DD4FC += g_DeltaTime2;

            g_WorldObject0.pose_1C.rotation_C.vx += FP_MULTIPLY_PRECISE(g_DeltaTime0, Q12(0.75f), Q12_SHIFT);
            g_WorldObject0.pose_1C.position_0.vy += FP_MULTIPLY_PRECISE(g_DeltaTime0, D_800DD4FC, Q12_SHIFT);
            g_WorldObject0.pose_1C.position_0.vz += FP_MULTIPLY_PRECISE(g_DeltaTime0, Q12(-0.5f), Q12_SHIFT);

            if (g_WorldObject0.pose_1C.position_0.vy >= 0)
            {
...
void func_800D87C0(void) // 0x800D87C0
{
    ...
    if (Savegame_EventFlagGet(EventFlag_76) && !Savegame_EventFlagGet(EventFlag_77))
    {
        ...
        obj->pose_1C.rotation_C.vy = FP_MULTIPLY_PRECISE(tmp0, FP_ANGLE(-4.1f), Q12_SHIFT) - FP_ANGLE(42.05f);
    }
}

...
#include "maps/shared/sharedFunc_800CEFD0_1_s02.h" // 0x800CDD3C
...
#include "maps/shared/sharedFunc_800DBF88_2_s00.h" // 0x800DA770

#include "maps/shared/sharedFunc_800DC0A8_2_s00.h" // 0x800DA890

#include "maps/shared/sharedFunc_800DC0E4_2_s00.h" // 0x800DA8CC
...
#include "maps/shared/sharedFunc_800DC438_2_s00.h" // 0x800DAC20

#include "maps/shared/sharedFunc_800DC50C_2_s00.h" // 0x800DACF4

#include "maps/shared/sharedFunc_800DC598_2_s00.h" // 0x800DAD80

#include "maps/shared/sharedFunc_800DC67C_2_s00.h" // 0x800DAE64

#include "maps/shared/sharedFunc_800DC6E4_2_s00.h" // 0x800DAECC

#include "maps/shared/sharedFunc_800DC894_2_s00.h" // 0x800DB07C

#include "maps/shared/sharedFunc_800D4AEC_0_s01.h" // 0x800DB174

#include "maps/shared/sharedFunc_800D4E84_0_s01.h" // 0x800DB50C

#include "maps/shared/sharedFunc_800D5274_0_s01.h" // 0x800DB8FC

#include "maps/shared/sharedFunc_800DD13C_2_s00.h" // 0x800DB924

#include "maps/shared/sharedFunc_800DD2C4_2_s00.h" // 0x800DBAAC

#include "maps/shared/sharedFunc_800DD4A4_2_s00.h" // 0x800DBC8C

#include "maps/shared/sharedFunc_800DD4EC_2_s00.h" // 0x800DBCD4

#include "maps/shared/sharedFunc_800DD534_2_s00.h" // 0x800DBD1C

#include "maps/shared/sharedFunc_800DD588_2_s00.h" // 0x800DBD70

#include "maps/shared/sharedFunc_800DD834_2_s00.h" // 0x800DC01C

#include "maps/shared/sharedFunc_800DDA80_2_s00.h" // 0x800DC268

#include "maps/shared/sharedFunc_800DDE14_2_s00.h" // 0x800DC5FC

#include "maps/shared/sharedFunc_800DDF74_2_s00.h" // 0x800DC75C

#include "maps/shared/sharedFunc_800DE034_2_s00.h" // 0x800DC81C

#include "maps/shared/sharedFunc_800DE11C_2_s00.h" // 0x800DC904

#include "maps/shared/sharedFunc_800DE1F8_2_s00.h" // 0x800DC9E0

#include "maps/shared/sharedFunc_800DE250_2_s00.h" // 0x800DCA38

#include "maps/shared/sharedFunc_800DE578_2_s00.h" // 0x800DCD60

#include "maps/shared/sharedFunc_800D529C_0_s01.h" // 0x800DCD80

#include "maps/shared/sharedFunc_800DE6A8_2_s00.h" // 0x800DCE90

#include "maps/shared/sharedFunc_800DE7E0_2_s00.h" // 0x800DCFC8

#include "maps/shared/sharedFunc_800D53AC_0_s01.h" // 0x800DD128
...
#include "maps/shared/sharedFunc_800DECC4_2_s00.h" // 0x800DD4AC

#include "maps/shared/sharedFunc_800DEE24_2_s00.h" // 0x800DD60C
...
#include "maps/shared/sharedFunc_800DF2D0_2_s00.h" // 0x800DDAB8

#include "maps/shared/sharedFunc_800DF358_2_s00.h" // 0x800DDB40
...
#include "maps/shared/sharedFunc_800DF8A0_2_s00.h" // 0x800DE088
...
#include "maps/shared/sharedFunc_800E012C_2_s00.h" // 0x800DE914

#include "maps/shared/sharedFunc_800E021C_2_s00.h" // 0x800DEA04

#include "maps/shared/sharedFunc_800E041C_2_s00.h" // 0x800DEC04

#include "maps/shared/sharedFunc_800E04B0_2_s00.h" // 0x800DEC98

#include "maps/shared/sharedFunc_800E0514_2_s00.h" // 0x800DECFC

#include "maps/shared/sharedFunc_800D5E78_0_s01.h" // 0x800DEDF8

#include "maps/shared/sharedFunc_800D5F00_0_s01.h" // 0x800DEE80
...
#include "maps/shared/sharedFunc_800D6600_0_s01.h" // 0x800DF580
...
#include "maps/shared/sharedFunc_800D7120_0_s01.h" // 0x800E00A0
...
#include "maps/shared/sharedFunc_800D77D0_0_s01.h" // 0x800E0750

#include "maps/shared/sharedFunc_800D7AB0_0_s01.h" // 0x800E0A30

#include "maps/shared/sharedFunc_800D7B14_0_s01.h" // 0x800E0A94

#include "maps/shared/sharedFunc_800D7EBC_0_s01.h" // 0x800E0E08

#include "maps/shared/sharedFunc_800D81B0_0_s01.h" // 0x800E10FC

#include "maps/shared/sharedFunc_800D81D0_0_s01.h" // 0x800E111C

#include "maps/shared/sharedFunc_800D8244_0_s01.h" // 0x800E1190

#include "maps/shared/sharedFunc_800D82B8_0_s01.h" // 0x800E1204
...
#include "maps/shared/sharedFunc_800E66E8_2_s02.h" // 0x800E66E8

#include "maps/shared/sharedFunc_800E6758_2_s02.h" // 0x800E6758

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E6878);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E6C40);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E7540);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E79D8);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E803C);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E8158);

#include "maps/shared/sharedFunc_800E83D4_2_s02.h" // 0x800E83D4

#include "maps/shared/sharedFunc_800E8478_2_s02.h" // 0x800E8478

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E8480);

#include "maps/shared/sharedFunc_800E86C0_2_s02.h" // 0x800E86C0

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", sharedFunc_800E8730_2_s02);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", sharedFunc_800E8A40_2_s02);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", sharedFunc_800E8DFC_2_s02);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E939C);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E94B4);

INCLUDE_ASM("maps/map2_s02/nonmatchings/map2_s02", func_800E9714);

#include "maps/shared/sharedFunc_800D929C_0_s00.h" // 0x800E992C

#include "maps/shared/Map_RoomIdxGet.h" // 0x800E993C

#include "maps/shared/sharedFunc_800E9B38_2_s02.h" // 0x800E9B38

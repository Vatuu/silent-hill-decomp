...
INCLUDE_ASM("asm/maps/map2_s00/nonmatchings/map2_s00", Ai_AirScreamer_Update); // 0x800D1F40
...
INCLUDE_ASM("asm/maps/map2_s00/nonmatchings/map2_s00", Ai_Groaner_Update); // 0x800E2F78

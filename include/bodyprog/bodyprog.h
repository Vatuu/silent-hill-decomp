...
typedef struct _MapPoint2d
{
    ...
    union
    {
        ...
        struct
        {
            ...
            s8  flags_6;     /** Copied to `stateStep_3` in `s_Model`, with `state_2 = ModelState_Uninitialized`. */
            s32 field_7_0 : 4;
        } spawnInfo;
        struct
        {
...
s32 func_8005CB20(s_SubCharacter* chara, s_800C4590* arg1, q3_12 x, q3_12 z);

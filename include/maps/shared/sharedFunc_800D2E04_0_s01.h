bool sharedFunc_800D2E04_0_s01(s_SubCharacter* chara, VECTOR3* inVec, s32* outDist, s32* outAngle)
{
    ...
    u8  idxInfo = g_SysWork.field_2388.field_154.field_0.field_0.field_0;
    s32 idx     = (idxInfo & (1 << 1)) ? ((idxInfo & (1 << 0)) ? 2 : 3) : (sharedFunc_800D4A80_0_s01(chara) == 3);

    s32 xDelta = inVec->vx - chara->position_18.vx;
    s32 zDelta = inVec->vz - chara->position_18.vz;
    ...
    if (((u32)temp_s3 * 2) >= tmp && temp_s4 >= dist)
    {
        ...
        return func_8006D90C(&sharedData_800E2330_0_s01, &sharedData_800DE170_0_s01, inVec) == 0;
    }

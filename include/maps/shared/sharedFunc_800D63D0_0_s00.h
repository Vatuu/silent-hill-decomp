void sharedFunc_800D63D0_0_s00(s_SubCharacter* stalker)
{
    ...
    if (!(stalker->properties_E4.stalker.flags_E8 & (1 << 13)))
    {
        // TODO: Use macro.
    ...
    // TODO: `stalker->properties_E4.stalker.flags_E8` doesn't match?
...
#endif
            stalker->properties_E4.stalker.flags_E8 |= StalkerFlag_9;
        }
    }

#if defined(MAP5_S02) || defined(MAP7_S02)
    if (stalker->properties_E4.stalker.flags_E8 & (1 << 9))
    {

void sharedFunc_800D92B4_2_s00(s_SubCharacter* airScreamer)
{
    ...
    {
        case 0:
            airScreamer->properties_E4.unk0.properties_120.val32 = (Rng_RandQ12() * 2) + Q12(0.5f);
        ...
        case 1:
            if (airScreamer->properties_E4.unk0.properties_120.val32 == 0 ||
                Math_Distance2dGet(&airScreamer->position_18, &airScreamer->properties_E4.unk0.field_F8) < Q12(2.0f))
            {

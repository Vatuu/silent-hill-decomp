        ...
        switch (nurse->properties_E4.puppetNurse.field_118) 
        {
            case 0:
                ...
                if (newHealth <= Q12(120.0f))
                {
                    ...
                    {
                        nurse->model_0.state_2 = PuppetNurseState_4;
                        nurse->model_0.stateStep_3 = 0;
                    }
                    else
                    {
                        nurse->model_0.state_2 = PuppetNurseState_3;
                        nurse->model_0.stateStep_3 = 0;
                    }
                ...
                {
                    if (nurse->model_0.state_2 != PuppetNurseState_2 && 
                         ...
                         (nurse->damage_B4.amount_C > Q12(320.0f))))
                    {
                        ...
                        nurse->model_0.state_2 = PuppetNurseState_2;
                        nurse->model_0.stateStep_3 = 0;
                    }
                }
                break;

void sharedFunc_800D94EC_2_s00(s_SubCharacter* airScreamer)
{
    ...
    switch (airScreamer->model_0.stateStep_3)
    {
        ...
        case 0:
            ...
            sharedFunc_800DECA4_2_s00(airScreamer, &airScreamerProps.position_F8, Q12(5.0f));

            airScreamer->model_0.stateStep_3 = AirScreamerStateStep_1;

        case 1:
            distFieldF8 = Math_Distance2dGet(&airScreamer->position_18, &airScreamerProps.position_F8);
            angleDiff   = FP_ANGLE_NORM_S(func_80080478(&airScreamer->position_18, &airScreamerProps.position_F8) - airScreamer->rotation_24.vy);
        ...
        case 67:
            ...
            airScreamer->model_0.stateStep_3 = AirScreamerStateStep_1;
            airScreamerProps.flags_11C |= CharaUnk0Flag_Unk12;
            break;
    }

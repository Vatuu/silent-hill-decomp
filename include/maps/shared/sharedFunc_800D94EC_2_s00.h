void sharedFunc_800D94EC_2_s00(s_SubCharacter* chara)
{
    ...
    {
        case 64:
            sharedFunc_800DD534_2_s00(chara);
        ...
        case 0:
            ...
            sharedFunc_800DEC84_2_s00(chara, Q12(6.0f), chara->rotation_24.vy);
            sharedFunc_800DECA4_2_s00(chara, &chara->properties_E4.unk0.field_F8, Q12(5.0f));

            chara->model_0.stateStep_3 = 1;

        case 1:
            distFieldF8 = Math_Distance2dGet(&chara->position_18, &chara->properties_E4.unk0.field_F8);
            angleDiff   = FP_ANGLE_NORM_S(func_80080478(&chara->position_18, &chara->properties_E4.unk0.field_F8) - chara->rotation_24.vy);

            if (temp_s4 == 2)
            {
                chara->model_0.stateStep_3 = 2;
            }
            else if (temp_s4 == 1 || (sharedFunc_800DC30C_2_s00(chara) && 
                                      cond == true && 
            ...
            else if (sharedFunc_800DC3BC_2_s00(chara) && 
                     cond == true && 
            ...
            else if (chara->properties_E4.unk0.properties_120.val32 == 0 || distFieldF8 < Q12(3.0f))
            {
        ...
        case 65:
            sharedFunc_800DDA80_2_s00(chara);
            chara->model_0.stateStep_3 = 1;
            break;

        case 66:
            sharedFunc_800DD588_2_s00(chara);
            chara->model_0.stateStep_3 = 1;
            break;

        case 67:
            sharedFunc_800DD834_2_s00(chara);
            chara->model_0.stateStep_3           = 1;
            chara->properties_E4.unk0.flags_11C |= CharaUnk0Flag_Unk12;
            break;
    }
            ...
            switch (switchCond)
            {
                ...
                case 2:
                    if (sp10 == 2)
                    {
                        if (!(field14C_1 | field14C_0 | field14C_2))
                        {
                            chara->model_0.controlState_2     = 18;
                            chara->model_0.stateStep_3 = 0;
                        }
                        else
                        {

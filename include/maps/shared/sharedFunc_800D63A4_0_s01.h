void sharedFunc_800D63A4_0_s01(s_SubCharacter* airScreamer)
{
    ...
    airScreamer->headingAngle_3C = rotY;

    sharedData_800DE1F0_0_s01.vx = FP_MULTIPLY_PRECISE(moveSpeed, Math_Sin(rotY), Q12_SHIFT);
    sharedData_800DE1F0_0_s01.vy = posY;
    sharedData_800DE1F0_0_s01.vz = FP_MULTIPLY_PRECISE(moveSpeed, Math_Cos(rotY), Q12_SHIFT);
    ...
    airScreamer->properties_E4.player.flags_11C &= ~PlayerFlag_Unk29;

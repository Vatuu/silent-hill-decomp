void sharedFunc_800D3B44_0_s00(s_SubCharacter* chara)
{
    ...
    if (!(g_SysWork.field_22A0 & (1 << 4)))
    {
        ...
        {
            sharedData_800E39EC_0_s00[var_s0] = sharedData_800E39EC_0_s00[var_s0 - 1];
            sharedData_800E3A0C_0_s00[var_s0] = sharedData_800E3A0C_0_s00[var_s0 - 1];
        }
        ...
        else
        {
            ...
            {
                var_s2 += func_8005BF38(sharedData_800E3A0C_0_s00[var_s0] - sharedData_800E3A0C_0_s00[var_s0 + 1]);
            }
            ...
            for (var_s0 = 0; var_s0 < 4; var_s0++)
            {
                var_s2 += sharedData_800E39EC_0_s00[var_s0] - sharedData_800E39EC_0_s00[var_s0 + 1];
            }

            temp_s1                   = sharedData_800E39EC_0_s00[0] + (var_s2 >> 2);
            sharedData_800E3A18_0_s00 = ((temp_s1 * Math_Sin(temp_a2)) >> 0xE) + g_SysWork.player_4C.chara_0.position_18.vx;
            sharedData_800E3A1C_0_s00 = ((temp_s1 * Math_Cos(temp_a2)) >> 0xE) + g_SysWork.player_4C.chara_0.position_18.vz;
        }
    }

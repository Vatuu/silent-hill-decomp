void Ai_HangedScratcher_Control_14(s_SubCharacter* scratcher)
{
    ...
    if ((scratcher->properties_E4.hangedScratcher.flags_E8 & HangedScratcherFlag_7) && 
    ...
    if (!(scratcher->properties_E4.hangedScratcher.flags_E8 & HangedScratcherFlag_6))
    {
        if (ANIM_TIME_RANGE_CHECK(scratcher->model_0.anim_4.time_4, 42, 44))
        {
            scratcher->properties_E4.hangedScratcher.flags_E8 |= HangedScratcherFlag_6;
    ...
    if (!(scratcher->properties_E4.hangedScratcher.flags_E8 & HangedScratcherFlag_8) && 
        ANIM_TIME_RANGE_CHECK(scratcher->model_0.anim_4.time_4, 52, 54))
    {
        scratcher->properties_E4.hangedScratcher.flags_E8 |= HangedScratcherFlag_8;

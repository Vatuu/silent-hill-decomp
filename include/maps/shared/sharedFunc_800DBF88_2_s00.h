bool sharedFunc_800DBF88_2_s00(s_SubCharacter* chara, s32 arg1)
{
    ...
    posXDelta = unkVec->vx - charaPosX;
    posYDelta = unkVec->vy - charaPosY;
    posZDelta = unkVec->vz - charaPosZ;

    unkPosY = unkVec->vy;

    charaFieldC8 = chara->field_C8;

    func_8006F250(sharedData_800E2370_0_s01, charaPosX, charaPosZ, posXDelta, posZDelta);

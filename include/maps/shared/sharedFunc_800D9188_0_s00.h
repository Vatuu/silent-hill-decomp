        ...
        if (chara->model_0.anim_4.keyframeIdx0_8 >= keyframeIdx)
        {
            if (!(chara->properties_E4.player.flags_11C & PlayerFlag_Unk13))
            {
                switch (sfx)
                {
#if defined(MAP6_S04)
                    case 0x654:
                        func_8005DC1C(sfx, &chara->position_18, FP_VOLUME(0.25f), 0);
                        break;
                    ...
                    case 0x656:
                    case 0x666:
                        func_8005DC1C(sfx, &chara->position_18, FP_VOLUME(0.75f), 0);
                        break;
                    ...
                    case 0x5D4:
                        func_8005DC1C(sfx, &chara->position_18, FP_VOLUME(1.0f), 2);
                        break;

                    case 0x63A:
                        func_8005DC1C(sfx, &chara->position_18, FP_VOLUME(0.5f), 0);
                        break;

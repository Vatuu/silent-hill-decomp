        ...
        if (arg1->model_0.anim_4.keyframeIdx0_8 >= arg2)
        {
            if (!(arg1->properties_E4.player.flags_11C & PlayerFlag_Unk13))
            {
                switch (sfx)
                {
#if defined(MAP6_S04)
                    case 0x654:
                        func_8005DC1C(sfx, &arg1->position_18, 0x40, 0);
                        break;
                    ...
                    case 0x656:
                    case 0x666:
                        func_8005DC1C(sfx, &arg1->position_18, 0xC0, 0);
                        break;
                    ...
                    case 0x5D4:
                        func_8005DC1C(sfx, &arg1->position_18, 0xFF, 2);
                        break;

                    case 0x63A:
                        func_8005DC1C(sfx, &arg1->position_18, 0x80, 0);
                        break;
                    ...
                    case 0x68A:
                    case 0x68B:
                        func_8005DC1C(sfx, &arg1->position_18, 0x20, 0);
                        break;

bool sharedFunc_800CF294_3_s03(s_SubCharacter* arg0, q19_12 dist)
{
    ...
    ret = false;
    if (func_8006FD90(arg0, 1, 
        FP_MULTIPLY_PRECISE(temp_v1, temp_a0, Q12_SHIFT),
        FP_MULTIPLY_PRECISE(somePtr->field_4, temp_a0, Q12_SHIFT)) || arg0->properties_E4.npc.field_11A > 0)
    {
        ret = true;
    }
    return ret;

void sharedFunc_800D67FC_0_s00(s_SubCharacter* chara)
{
    ...
    if ((u16)chara->properties_E4[1] & (1 << 13))
    {
        ...
        if (newMoveSpeed == 0)
        {
            *(u16*)&chara->properties_E4[1] &= ~(1 << 13);
        }
    }
    else
    {
    ...
    if ((u16)chara->properties_E4[1] & (1 << 12))
    {
    ...
    if (g_DeltaTime0 != 0)
    {
        func_8005CB20(chara, &sp10, *(s16*)&chara->properties_E4[2], *((s16*)&chara->properties_E4[2] + 1));
    }

    *((u16*)&chara->properties_E4[2] + 1) = 0;
    *(u16*)&chara->properties_E4[2]       = 0;
    chara->moveSpeed_38                   = origMoveSpeed;

    if (chara->field_34 != 0)
    {
        newFlags = chara->properties_E4[1] | (1 << 8);
    }
    else
    {
        newFlags = chara->properties_E4[1] & ~(1 << 8);
    ...
    *(u16*)&chara->properties_E4[1] = newFlags;
}

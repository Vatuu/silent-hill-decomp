...
void sharedFunc_800D2244_0_s00(s32 arg0)
{
    ...
    if (arg0 != 0)
    {
        ...
        player->model_0.anim_4.time_4  = QX_12(503);
        player->model_0.anim_4.alpha_A = QX_12(1.0f);
        extra->model_0.anim_4.time_4   = QX_12(503);
        extra->model_0.anim_4.alpha_A  = QX_12(1.0f);
    }
    else
    {
        g_SysWork.player_4C.extra_128.state_1C = PlayerState_None;
    ...
    g_SysWork.player_4C.chara_0.field_C8                        = QX_12(-1.6f);
    g_SysWork.player_4C.chara_0.field_CE                        = QX_12(-1.1f);

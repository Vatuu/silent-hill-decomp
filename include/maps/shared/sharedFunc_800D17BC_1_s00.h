...
void sharedFunc_800D17BC_1_s00(s_SubCharacter* chara)
{
    ...
    chara->properties_E4.dummy.properties_E8[4].val32     = g_SysWork.playerWork_4C.player_0.position_18.vx;
    chara->properties_E4.dummy.properties_E8[5].val32     = g_SysWork.playerWork_4C.player_0.position_18.vz;

    if (chara->model_0.state_2 == 11)
    {
        if (ANIM_STATUS_IDX_GET(chara->model_0.anim_4.status_0) == 9)
        {
            chara->properties_E4.dummy.properties_E8[3].val16[1] = NO_VALUE;
    ...
    {
        if (func_8005BF38(ratan2(g_SysWork.playerWork_4C.player_0.position_18.vx - chara->position_18.vx, g_SysWork.playerWork_4C.player_0.position_18.vz - chara->position_18.vz) - chara->rotation_24.vy) < 0)
        {
            angle = -func_8005BF38(ratan2(g_SysWork.playerWork_4C.player_0.position_18.vx - chara->position_18.vx, g_SysWork.playerWork_4C.player_0.position_18.vz - chara->position_18.vz) - chara->rotation_24.vy);
        }
        else
        {
            angle = func_8005BF38(ratan2(g_SysWork.playerWork_4C.player_0.position_18.vx - chara->position_18.vx, g_SysWork.playerWork_4C.player_0.position_18.vz - chara->position_18.vz) - chara->rotation_24.vy);
        ...
        if (chara->health_B0 > Q12(100.0f))
        {
            ...
            if (angle < FP_ANGLE(90.0f))
            {
                ...
                {
                    chara->properties_E4.dummy.properties_E8[3].val16[1] = keyframeOffset;
                    ...
                    chara->properties_E4.dummy.properties_E8[3].val16[0] = 76 - FP_FROM(chara->model_0.anim_4.time_4, Q12_SHIFT);
                }
                else if (keyframe2 >= 73 && keyframe2 < 75)
                {
                    chara->properties_E4.dummy.properties_E8[3].val16[1] = keyframeOffset;
                    chara->model_0.anim_4.status_0                               = ANIM_STATUS(5, false);
                    chara->properties_E4.dummy.properties_E8[3].val16[0] = 5;
                }
                else if (keyframe2 >= 75 && keyframe2 < 79)
                {
                    ...
                    chara->model_0.anim_4.status_0                               = ANIM_STATUS(5, false);
                    chara->properties_E4.dummy.properties_E8[3].val16[0] = 79 - FP_FROM(chara->model_0.anim_4.time_4, Q12_SHIFT);
                }
                else
                {
            ...
            else
            {
                ...
                else if (keyframe2 >= 105 && keyframe2 < 119)
                {
                    ...
                    chara->properties_E4.dummy.properties_E8[3].val16[1] = keyframeOffset;
                    chara->properties_E4.dummy.properties_E8[3].val16[0] = 7 - ((FP_FROM(chara->model_0.anim_4.time_4, Q12_SHIFT) - 104) >> 1);
                }
                else
                {
                    chara->properties_E4.dummy.properties_E8[3].val16[0] = 0;
        ...
        else
        {
            ...
            if (angle < FP_ANGLE(90.0f))
            {
                ...
                if (keyframe >= 41 && keyframe < 52)
                {
                    ...
                    chara->properties_E4.dummy.properties_E8[3].val16[0] = keyframeOffset;
                    chara->properties_E4.dummy.properties_E8[3].val16[1] = keyframeOffset;
                }
    ...
    chara->properties_E4.dummy.properties_E8[8].val16[0] = 0;
    chara->properties_E4.dummy.properties_E8[1].val32    = 0;
}

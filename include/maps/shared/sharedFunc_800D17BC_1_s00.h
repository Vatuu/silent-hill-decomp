...
void sharedFunc_800D17BC_1_s00(s_SubCharacter* chara)
{
    ...
    if (chara->dmg_B4.damageReceived_C <= Q12(0.0f) || chara->health_B0 <= Q12(0.0f))
    {
        return;
    }
    ...
    chara->health_B0       = MAX(chara->health_B0 - chara->dmg_B4.damageReceived_C, Q12(0.0f));
    chara->dmg_B4.field_0       += FP_FROM(chara->moveSpeed_38 * Math_Sin(chara->headingAngle_3C), Q12_SHIFT);
    chara->dmg_B4.field_8       += FP_FROM(chara->moveSpeed_38 * Math_Cos(chara->headingAngle_3C), Q12_SHIFT);
    chara->moveSpeed_38    = FP_TO(Math_Vector2MagCalc(chara->dmg_B4.field_0, chara->dmg_B4.field_8), Q12_SHIFT) / Q12(2.4f);
    chara->field_34        = FP_TO(chara->dmg_B4.field_4, Q12_SHIFT) / Q12(2.4f);
    chara->headingAngle_3C = ratan2(chara->dmg_B4.field_0, chara->dmg_B4.field_8);

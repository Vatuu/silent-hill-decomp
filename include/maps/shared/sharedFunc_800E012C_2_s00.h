void sharedFunc_800E012C_2_s00(s_SubCharacter* airScreamer)
{
    ...
    temp_v1 = func_80080478(&airScreamer->position_18, &airScreamer->properties_E4.airScreamer.targetPosition_F8);
    temp_v1 = FP_ANGLE_NORM_S(temp_v1 - airScreamer->rotation_24.vy);
    ...
    sharedData_800E21D0_0_s01.field_B4[idx][3] = temp_v1;
    ...
    sharedFunc_800D5E78_0_s01(airScreamer, temp_v1 / 2);
}
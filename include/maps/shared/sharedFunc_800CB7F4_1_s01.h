void sharedFunc_800CB7F4_1_s01(void)
{
    ...
    for (i = 0; i < ARRAY_SIZE(sharedData_800DFB7C_0_s00); i++)
    {
        ...
        sharedData_800DFB7C_0_s00[i].field_C.field_0 = ((FP_TO(sharedData_800DEE50_1_s01.field_6 - sharedData_800DEE50_1_s01.field_8, Q12_SHIFT) / sharedData_800DEE50_1_s01.field_C) * count) / sharedData_800DEE50_1_s01.field_4;

void Ai_Stalker_Init(s_SubCharacter* chara)
{
    ...
    switch (chara->model_0.stateStep_3)
    {
        ...
        case 3:
            chara->properties_E4.dummy.properties_E8[4].val32     = Q12(2.5f);
        ...
        case 6:
            ...
            chara->properties_E4.dummy.properties_E8[4].val32     = Q12(1.0f);
            chara->properties_E4.dummy.properties_E8[0].val16[0] |= (1 << 0) | (1 << 1);
            chara->field_E1_0                                             = 3;
    ...
    chara->properties_E4.dummy.properties_E8[6].val16[1] = NO_VALUE;
    chara->properties_E4.dummy.properties_E8[2].val32    = chara->position_18.vx;
    chara->properties_E4.dummy.properties_E8[3].val32    = chara->position_18.vz;
    chara->properties_E4.dummy.properties_E8[10].val32   = chara->health_B0;

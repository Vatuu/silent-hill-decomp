void sharedFunc_800E3E94_2_s00(s_SubCharacter* chara)
{
    s16           temp_v0_10;
    s16           angle0;
    s16           angle1;
    ...
    mag0 = Math_Vector2MagCalc(g_SysWork.playerWork_4C.player_0.position_18.vx - chara->position_18.vx,
                               g_SysWork.playerWork_4C.player_0.position_18.vz - chara->position_18.vz);

    temp = Rng_GenerateInt(0x4000, 0x7FFF);

    temp_s6 = func_800700F8(chara, &g_SysWork.playerWork_4C.player_0);

    if (mag0 < temp && !temp_s6)
    {
        chara->properties_E4.groaner.angle_FC = ratan2(g_SysWork.playerWork_4C.player_0.position_18.vx - chara->position_18.vx,
                                                       g_SysWork.playerWork_4C.player_0.position_18.vz - chara->position_18.vz);
    }
    else
    {
        temp_s2 = 0xE66 - Rng_GenerateInt(0, 920);
        temp_s4 = func_8007029C(chara, temp_s2, chara->rotation_24.vy);

        if ((chara->properties_E4.groaner.field_104 >= 0 && ((temp_s4 != 0 && (temp_s6 || mag0 < temp_s2)) ||
                                                            chara->properties_E4.groaner.field_104 == 0)) ||
            !Rng_TestProbabilityBits(5))
        {
            ...
            headingAngle = Chara_HeadingAngleGet(chara, var_a1, chara->properties_E4.dummy.properties_E8[3].val32,
                                                 chara->properties_E4.dummy.properties_E8[4].val32, FP_ANGLE(360.0f), true);
            if (headingAngle == 0x1000)
            {
                headingAngle = func_8006F99C(chara, (temp_s2 * 3) >> 2, chara->rotation_24.vy);
            }
            ...
            {
                chara->properties_E4.groaner.field_104 = Rng_GenerateInt(0x600, 0x17FF);
            }

            chara->properties_E4.groaner.angle_FC = headingAngle;
        }
    }
    ...
    for (i = 0; i < 3; i++)
    {
        angle0 = func_8005BF38(chara->properties_E4.groaner.angle_FC - chara->rotation_24.vy);
    ...
    angle1 = func_8005BF38(chara->properties_E4.groaner.angle_FC - chara->rotation_24.vy);
    ...
    if (var_a0 && !temp_s6)
    {
        ...
        if (!(playerWork->player_0.flags_3E & 8) && !(g_SysWork.field_2284[3] & 2) &&
            ...
            chara->position_18.vy - g_SysWork.playerWork_4C.player_0.position_18.vy >= -0xCCB)
        {
            if (chara->position_18.vy - g_SysWork.playerWork_4C.player_0.position_18.vy < 0xCCC)
            {
                if (ABS(func_8005BF38(ratan2(g_SysWork.playerWork_4C.player_0.position_18.vx - chara->position_18.vx,
                                             g_SysWork.playerWork_4C.player_0.position_18.vz - chara->position_18.vz) -
                                      chara->rotation_24.vy)) < 0x155)
                {
                    g_SysWork.field_2284[3]      |= 2;
                    chara->model_0.controlState_2  = 3;
                    chara->model_0.anim_4.status_0 = 30;
                    return;
                }
            }
        }
    ...
    if (!(chara->properties_E4.dummy.properties_E8[0].val16[0] & 0x80) &&
        (mag0 > 0xC000 || (!Rng_TestProbabilityBits(7) && (mag0 > 0x6000))))
    {
        chara->model_0.controlState_2                         = 1;
        chara->model_0.anim_4.status_0                        = 34;
        chara->properties_E4.dummy.properties_E8[6].val16[0]  = 0x64;
        chara->properties_E4.dummy.properties_E8[0].val16[0] &= 0xFBFF;
    }
}

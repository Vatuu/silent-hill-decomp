void sharedFunc_800CB8A0_1_s01(s32 idx)
{
    ...
    if (sharedData_800DEE50_1_s01.field_0 == 0)
    {
        ...
        sharedData_800DD5B0_1_s01[idx].vx_0 = (s32)(rngX * Math_Cos(angleZ)) >> Q12_SHIFT;
        sharedData_800DD5B0_1_s01[idx].vz_4 = (s32)(rngX * Math_Sin(angleZ)) >> Q12_SHIFT;
    }
    else
    {
        sharedData_800DD5B0_1_s01[idx].vx_0 = (Rng_Rand16() % (sharedData_800DEE50_1_s01.field_A * 2)) - sharedData_800DEE50_1_s01.field_A;
        sharedData_800DD5B0_1_s01[idx].vz_4 = (Rng_Rand16() % (sharedData_800DEE50_1_s01.field_A * 2)) - sharedData_800DEE50_1_s01.field_A;
    }

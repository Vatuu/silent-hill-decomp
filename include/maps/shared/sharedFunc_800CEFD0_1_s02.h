void sharedFunc_800CEFD0_1_s02(s32 arg0, s_sharedFunc_800CEFD0_1_s02* arg1, u16* arg2, s32* deltaTimePtr)
{
    ...
    if (arg0 == 1)
    {
        ...
        var_s0->field_0.vx += ((sharedData_800DFB64_0_s00 + var_t0) * *deltaTimePtr) / 136;
        var_s0->field_1A += sharedData_800E5768_1_s02;
        var_s0->field_0.vy += ((var_s0->field_1A << 2) * *deltaTimePtr) / 136;
        var_s0->field_0.vz += ((sharedData_800DFB68_0_s00 + var_t1) * *deltaTimePtr) / 136;
        ...
        if ((temp_v1 >= 0 && (var_v0 + temp_v1) > FP_METER(6)) ||
            (temp_v1 < 0 && (var_v0 - temp_v1) > FP_METER(6)))
        {
            if (sharedData_800DF158_1_s02 != 0)
            {
        ...
        if (var_s0->field_0.vy >= 0)
        {
            ...
            if (sp10.field_8 == 0xB)
            {
                ...
                var_s0->field_C.vx = var_s0->field_0.vx;
                var_s0->field_C.vz = var_s0->field_0.vz;
                var_s0->field_C.vy = var_s0->field_0.vy - 0x60;
            }
            var_s0->field_1C = 0;
            var_s0->field_1A = 0;
            var_s0->field_1E += 1;

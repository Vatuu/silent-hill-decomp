...
/*s_AnimInfo DAHLIA_ANIM_INFOS[] = {
    ...
    { Anim_Update2, ANIM_STATUS(4, false), false, ANIM_STATUS(4, true), { Q12(3.0f) }, NO_VALUE, 86 },
    { Anim_Update0, ANIM_STATUS(4, true), false, ANIM_STATUS(4, true), { Q12(2.0f) }, 86, 109 },
    { Anim_Update2, ANIM_STATUS(5, false), false, ANIM_STATUS(5, true), { Q12(2.0f) }, NO_VALUE, 110 },
    { Anim_Update0, ANIM_STATUS(5, true), false, ANIM_STATUS(5, true), { Q12(3.5f) }, 110, 166 },
    { Anim_Update2, ANIM_STATUS(6, false), false, ANIM_STATUS(6, true), { Q12(5.0f) }, NO_VALUE, 176 },
    { Anim_Update0, ANIM_STATUS(6, true), false, ANIM_STATUS(6, true), { Q12(5.0f) }, 176, 226 },
    { Anim_Update2, ANIM_STATUS(7, false), false, ANIM_STATUS(7, true), { Q12(15.0f) }, NO_VALUE, 227 },
    { Anim_Update0, ANIM_STATUS(7, true), false, ANIM_STATUS(7, true), { Q12(8.0f) }, 236, 247 },

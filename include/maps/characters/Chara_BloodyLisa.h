...
/*s_AnimInfo BLOODY_LISA_ANIM_INFOS[] = {
    { Anim_Update2, ANIM_STATUS(BloodyLisaAnim_Still, false), false, ANIM_STATUS(BloodyLisaAnim_Still, false), { Q12(0.0f)  }, NO_VALUE, 0   },
    { Anim_Update1, ANIM_STATUS(BloodyLisaAnim_Still, true),  false, NO_VALUE,                                 { Q12(30.0f) }, NO_VALUE, 1   },
    { Anim_Update2, ANIM_STATUS(BloodyLisaAnim_Walk,  false), false, ANIM_STATUS(BloodyLisaAnim_Walk,  true),  { Q12(10.0f) }, NO_VALUE, 0   },
    { Anim_Update0, ANIM_STATUS(BloodyLisaAnim_Walk,  true),  false, ANIM_STATUS(BloodyLisaAnim_Walk,  true),  { Q12(10.0f) }, 0,        100 }
};*/
